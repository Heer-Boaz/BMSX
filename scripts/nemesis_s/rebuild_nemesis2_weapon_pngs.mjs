...
// TMS9918A palette values used by the source machine. Index zero remains
// transparent in the extracted cart assets.
const palette = [
	[0, 0, 0],
	[0, 0, 0],
	[33, 200, 66],
...
const writeIndexedPng = (name, width, height, indices) => {
	...
	for (let pixel = 0; pixel < indices.length; pixel += 1) {
		...
		png.data[output + 3] = paletteIndex === 0 ? 0 : 255;
	}
