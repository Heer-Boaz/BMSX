...
export const bool01DuplicatePatternRule = defineLintRule('lua_cart', 'bool01_duplicate_pattern');

export function lintBool01DuplicatePattern(functionName: string, functionExpression: LuaFunctionExpression, issues: LuaLintIssue[]): void {
