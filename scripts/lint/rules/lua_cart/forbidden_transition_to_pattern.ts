...
import { type LuaCallExpression as CallExpression } from '../../../../machine/ts/lua/syntax/ast';
import { type CartLintIssue } from '../../lua_rule';
import { lintForbiddenMatchesStatePathPattern } from './forbidden_matches_state_path_pattern';
import { getCallMethodName, getCallReceiverName } from '../../../../machine/ts/lua/syntax/calls';
