import { type LuaExpression as Expression, type LuaFunctionExpression as CartFunctionExpression, type LuaIfClause as IfClause, type LuaIfStatement as IfStatement, type LuaLocalAssignmentStatement as LocalAssignmentStatement, type LuaStatement as Statement, LuaSyntaxKind as SyntaxKind } from '../../../../../../machine/ts/lua/syntax/ast';
