import { type LuaCallExpression, type LuaExpression, type LuaStatement, LuaSyntaxKind, LuaTableFieldKind } from '../../../../../../src/bmsx/lua/syntax/ast';
...
export function getCallReceiverName(expression: LuaCallExpression): string {
	if (expression.methodName && expression.callee.kind === LuaSyntaxKind.IdentifierExpression) {
...
export function getCallMethodName(expression: LuaCallExpression): string {
