...
import { type LuaLocalAssignmentStatement } from '../../../../src/bmsx/lua/syntax/ast';
...
export const selfPropertyLocalAliasPatternRule = defineLintRule('lua_cart', 'self_property_local_alias_pattern');

export function lintLocalAssignment(statement: LuaLocalAssignmentStatement, issues: LuaLintIssue[]): void {
