...
import { type LuaLocalAssignmentStatement as LocalAssignmentStatement } from '../../../../toolchain/ts/lua/syntax/ast';
...
export function lintLocalAssignment(statement: LocalAssignmentStatement, lint: CartLintContext): void {
