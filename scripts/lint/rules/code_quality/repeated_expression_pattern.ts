...
import { cppTokenText, normalizedTokenText, type Token } from '../../language/cpp/syntax/tokens';
import { collectStatementRanges, cppRangeHas, isAccessSeparator, isClockNowCallTarget, isComparisonOperator } from '../../language/cpp/syntax/syntax';
