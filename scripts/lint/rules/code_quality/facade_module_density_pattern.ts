...
import { isFunctionLikeValue } from '../../../../packages/bmsx-console/src/language/ts/ast/functions';
import { getCallExpressionTarget, hasExportModifier } from '../../../../packages/bmsx-console/src/language/ts/ast/expressions';
