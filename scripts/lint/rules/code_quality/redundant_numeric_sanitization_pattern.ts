...
import { isNumericSanitizerCall, isSemanticFloorDivisionCall as isAstSemanticFloorDivisionCall, isSplitRoundingSanitizerThenBoundsCheck } from '../../language/ts/ast/semantic';
import { containsDescendantCallExpression, parentChainContainsCallExpression } from '../../language/ts/ast/expressions';
import { nodeStartLine } from '../ts/support/ast';
import { type FunctionInfo } from '../../language/cpp/syntax/declarations';
import { cppCallTarget, findAccessChainStart } from '../../language/cpp/syntax/syntax';
