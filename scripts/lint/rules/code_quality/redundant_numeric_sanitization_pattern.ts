...
import { isNumericSanitizerCall, isSemanticFloorDivisionCall as isAstSemanticFloorDivisionCall, isSplitRoundingSanitizerThenBoundsCheck } from '../../../../machine/ts/src/language/ts/ast/semantic';
import { containsDescendantCallExpression, parentChainContainsCallExpression } from '../../../../machine/ts/src/language/ts/ast/expressions';
import { nodeStartLine } from '../ts/support/ast';
import { type FunctionInfo } from '../../../../machine/ts/src/language/cpp/syntax/declarations';
import { cppCallTarget, findAccessChainStart } from '../../../../machine/ts/src/language/cpp/syntax/syntax';
