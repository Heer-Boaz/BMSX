...
import { isLuaNilLiteral as isNilLiteral, luaBinaryExpressionHasOperand } from '../../../../toolchain/ts/lua/syntax/literals';
...
export function lintAstOrNilFallbackPattern(expression: Expression, lint: CartLintContext, pushIssue: CartLintIssuePusher): void {
