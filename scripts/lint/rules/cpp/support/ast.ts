import { CPP_CONTROL_CALL_KEYWORDS, findAccessChainStart, findNextTokenText, hasDeclarationPrefix, isAccessSeparator, isComparisonOperator, previousIdentifier, trimmedExpressionText } from '../../../language/cpp/syntax/syntax';
import { type Token, cppTokenText } from '../../../language/cpp/syntax/tokens';
