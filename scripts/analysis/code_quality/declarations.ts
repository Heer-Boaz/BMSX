...
import { getExpressionText, getPropertyName, hasExportModifier } from '../../../machine/ts/src/language/ts/ast/expressions';
import { getFunctionSignature, isFunctionLikeValue } from '../../../machine/ts/src/language/ts/ast/functions';
