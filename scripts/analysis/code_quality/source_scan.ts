...
import { getCallTargetLeafName, getPropertyName, hasQuestionDotToken, unwrapExpression } from '../../../machine/ts/src/language/ts/ast/expressions';
import { isFunctionLikeValue, isFunctionLikeWithParameters } from '../../../machine/ts/src/language/ts/ast/functions';
