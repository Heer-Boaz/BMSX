...
import { getCallTargetLeafName, getPropertyName, hasQuestionDotToken, unwrapExpression } from '../../../packages/bmsx-console/src/language/ts/ast/expressions';
import { isFunctionLikeValue, isFunctionLikeWithParameters } from '../../../packages/bmsx-console/src/language/ts/ast/functions';
