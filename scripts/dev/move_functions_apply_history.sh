...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/diagnostics.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/search_ui.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/window_listeners.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/runtime_overlay.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/topbar.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/pointer.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/navigation.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/editor_core.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/lifecycle.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/input_and_prompt.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/symbols_focus.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/topbar_pointer_actions.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/pointer_inline.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/resource_panel.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/text_editing.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/undo_snapshot.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/viewport.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/cursor.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/search_navigation.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/resources.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/ui_render.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/input_handlers.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/tabs_nav.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/utils_editor.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/console_cart_editor.ts \
	--dest machine/ts/src/ide/search_helpers.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_breakpoints.ts \
	--dest machine/ts/src/ide/debugger.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_controls.ts \
	--dest machine/ts/src/ide/debugger.ts \
	-n getDebuggerCommandExecutor -n issueDebuggerCommand

node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_overlay_controller.ts \
	--dest machine/ts/src/ide/debugger.ts \
	-n showDebuggerPauseOverlay -n clearDebuggerPauseOverlay -n prepareDebuggerStepOverlay

node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_shortcuts.ts \
	--dest machine/ts/src/ide/debugger.ts \
	-n handleDebuggerShortcuts

node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_shortcuts_core.ts \
	--dest machine/ts/src/ide/debugger.ts \
	-n evaluateDebuggerShortcuts

node scripts/move_functions.js \
	--source machine/ts/src/ide/debugger_ui_state.ts \
	--dest machine/ts/src/ide/debugger.ts \
	-n initializeDebuggerUiState

# Merge render files into render.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/render_caret.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderInlineCaret -n drawInlineCaret -n getCaretGlyphForDisplay -n drawCursor

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_code_area.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderCodeArea

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_error_overlay.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderRuntimeErrorOverlay

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_inline_bars.ts \
	--dest machine/ts/src/ide/render.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/render_resource_panel.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderResourcePanel

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_status_bar.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderStatusBar

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_tab_bar.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderTabBar

node scripts/move_functions.js \
	--source machine/ts/src/ide/render_top_bar.ts \
	--dest machine/ts/src/ide/render.ts \
	-n renderTopBar

# Merge runtime error overlay files into runtime_error_overlay.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/runtime_error_overlay_model.ts \
	--dest machine/ts/src/ide/runtime_error_overlay.ts \
	-n cloneRuntimeErrorDetails -n rebuildRuntimeErrorOverlayView -n buildRuntimeErrorOverlayCopyText

node scripts/move_functions.js \
	--source machine/ts/src/ide/runtime_error_overlay_navigation.ts \
	--dest machine/ts/src/ide/runtime_error_overlay.ts \
	-n navigateRuntimeErrorOverlay

# Merge rename files into rename.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/rename_apply.ts \
	--dest machine/ts/src/ide/rename.ts \
	-n applyRename

node scripts/move_functions.js \
	--source machine/ts/src/ide/rename_controller.ts \
	--dest machine/ts/src/ide/rename.ts \
	-n handleRename

node scripts/move_functions.js \
	--source machine/ts/src/ide/rename_cross_file.ts \
	--dest machine/ts/src/ide/rename.ts \
	-n renameCrossFile

# Merge reference files into reference.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/reference_navigation.ts \
	--dest machine/ts/src/ide/reference.ts \
	-n navigateReferences

node scripts/move_functions.js \
	--source machine/ts/src/ide/reference_sources.ts \
	--dest machine/ts/src/ide/reference.ts \
	-n getReferenceSources

# Merge text utils files into text_utils.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/text_utils_local.ts \
	--dest machine/ts/src/ide/text_utils.ts \
	-n localTextUtils

# Merge input files into input.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/input_controller.ts \
	--dest machine/ts/src/ide/input.ts \
	-n handleInput

node scripts/move_functions.js \
	--source machine/ts/src/ide/input_helpers.ts \
	--dest machine/ts/src/ide/input.ts \
...
node scripts/move_functions.js \
	--source machine/ts/src/ide/player_input_adapter.ts \
	--dest machine/ts/src/ide/input.ts \
	-n adaptPlayerInput

# Merge semantic files into semantic.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/semantic_model.ts \
	--dest machine/ts/src/ide/semantic.ts \
	-n buildSemanticModel

node scripts/move_functions.js \
	--source machine/ts/src/ide/semantic_worker.ts \
	--dest machine/ts/src/ide/semantic.ts \
	-n runSemanticWorker

node scripts/move_functions.js \
	--source machine/ts/src/ide/semantic_workspace.ts \
	--dest machine/ts/src/ide/semantic.ts \
	-n manageSemanticWorkspace

# Merge editor inputs into editor_inputs.ts
node scripts/move_functions.js \
	--source machine/ts/src/ide/editor_modal_inputs.ts \
	--dest machine/ts/src/ide/editor_inputs.ts \
	-n handleModalInputs

node scripts/move_functions.js \
	--source machine/ts/src/ide/inline_text_field.ts \
	--dest machine/ts/src/ide/editor_inputs.ts \
