...
node scripts/move_functions.js \
	--source machine/ts/ide/debugger_breakpoints.ts \
	--dest machine/ts/ide/debugger.ts \
...
node scripts/move_functions.js \
	--source machine/ts/ide/debugger_controls.ts \
	--dest machine/ts/ide/debugger.ts \
	-n getDebuggerCommandExecutor -n issueDebuggerCommand

node scripts/move_functions.js \
	--source machine/ts/ide/debugger_overlay_controller.ts \
	--dest machine/ts/ide/debugger.ts \
	-n showDebuggerPauseOverlay -n clearDebuggerPauseOverlay -n prepareDebuggerStepOverlay

node scripts/move_functions.js \
	--source machine/ts/ide/debugger_shortcuts.ts \
	--dest machine/ts/ide/debugger.ts \
	-n handleDebuggerShortcuts

node scripts/move_functions.js \
	--source machine/ts/ide/debugger_shortcuts_core.ts \
	--dest machine/ts/ide/debugger.ts \
	-n evaluateDebuggerShortcuts

node scripts/move_functions.js \
	--source machine/ts/ide/debugger_ui_state.ts \
	--dest machine/ts/ide/debugger.ts \
	-n initializeDebuggerUiState

# Merge render files into render.ts
node scripts/move_functions.js \
	--source machine/ts/ide/render_caret.ts \
	--dest machine/ts/ide/render.ts \
	-n renderInlineCaret -n drawInlineCaret -n getCaretGlyphForDisplay -n drawCursor

node scripts/move_functions.js \
	--source machine/ts/ide/render_code_area.ts \
	--dest machine/ts/ide/render.ts \
	-n renderCodeArea

node scripts/move_functions.js \
	--source machine/ts/ide/render_error_overlay.ts \
	--dest machine/ts/ide/render.ts \
	-n renderRuntimeErrorOverlay

node scripts/move_functions.js \
	--source machine/ts/ide/render_inline_bars.ts \
	--dest machine/ts/ide/render.ts \
...
node scripts/move_functions.js \
	--source machine/ts/ide/render_resource_panel.ts \
	--dest machine/ts/ide/render.ts \
	-n renderResourcePanel

node scripts/move_functions.js \
	--source machine/ts/ide/render_status_bar.ts \
	--dest machine/ts/ide/render.ts \
	-n renderStatusBar

node scripts/move_functions.js \
	--source machine/ts/ide/render_tab_bar.ts \
	--dest machine/ts/ide/render.ts \
	-n renderTabBar

node scripts/move_functions.js \
	--source machine/ts/ide/render_top_bar.ts \
	--dest machine/ts/ide/render.ts \
	-n renderTopBar

# Merge runtime error overlay files into runtime_error_overlay.ts
node scripts/move_functions.js \
	--source machine/ts/ide/runtime_error_overlay_model.ts \
	--dest machine/ts/ide/runtime_error_overlay.ts \
	-n cloneRuntimeErrorDetails -n rebuildRuntimeErrorOverlayView -n buildRuntimeErrorOverlayCopyText

node scripts/move_functions.js \
	--source machine/ts/ide/runtime_error_overlay_navigation.ts \
	--dest machine/ts/ide/runtime_error_overlay.ts \
	-n navigateRuntimeErrorOverlay

# Merge rename files into rename.ts
node scripts/move_functions.js \
	--source machine/ts/ide/rename_apply.ts \
	--dest machine/ts/ide/rename.ts \
	-n applyRename

node scripts/move_functions.js \
	--source machine/ts/ide/rename_controller.ts \
	--dest machine/ts/ide/rename.ts \
	-n handleRename

node scripts/move_functions.js \
	--source machine/ts/ide/rename_cross_file.ts \
	--dest machine/ts/ide/rename.ts \
	-n renameCrossFile

# Merge reference files into reference.ts
node scripts/move_functions.js \
	--source machine/ts/ide/reference_navigation.ts \
	--dest machine/ts/ide/reference.ts \
	-n navigateReferences

node scripts/move_functions.js \
	--source machine/ts/ide/reference_sources.ts \
	--dest machine/ts/ide/reference.ts \
	-n getReferenceSources

# Merge text utils files into text_utils.ts
node scripts/move_functions.js \
	--source machine/ts/ide/text_utils_local.ts \
	--dest machine/ts/ide/text_utils.ts \
	-n localTextUtils

# Merge input files into input.ts
node scripts/move_functions.js \
	--source machine/ts/ide/input_controller.ts \
	--dest machine/ts/ide/input.ts \
	-n handleInput

node scripts/move_functions.js \
	--source machine/ts/ide/input_helpers.ts \
	--dest machine/ts/ide/input.ts \
...
node scripts/move_functions.js \
	--source machine/ts/ide/player_input_adapter.ts \
	--dest machine/ts/ide/input.ts \
	-n adaptPlayerInput

# Merge semantic files into semantic.ts
node scripts/move_functions.js \
	--source machine/ts/ide/semantic_model.ts \
	--dest machine/ts/ide/semantic.ts \
	-n buildSemanticModel

node scripts/move_functions.js \
	--source machine/ts/ide/semantic_worker.ts \
	--dest machine/ts/ide/semantic.ts \
	-n runSemanticWorker

node scripts/move_functions.js \
	--source machine/ts/ide/semantic_workspace.ts \
	--dest machine/ts/ide/semantic.ts \
	-n manageSemanticWorkspace

# Merge editor inputs into editor_inputs.ts
node scripts/move_functions.js \
	--source machine/ts/ide/editor_modal_inputs.ts \
	--dest machine/ts/ide/editor_inputs.ts \
	-n handleModalInputs

node scripts/move_functions.js \
	--source machine/ts/ide/inline_text_field.ts \
	--dest machine/ts/ide/editor_inputs.ts \
