...
import {
	...
	type ImgMeta,
	type RomAsset,
} from '../../machine/ts/src/rompack/format';
import { SYSTEM_ROM_NAME } from '../../machine/ts/src/core/system';
import {
	commonResPath,
	createAtlasses,
	generateRomAssets,
...
export const HOST_SYSTEM_ATLAS_TS_PATH = join(process.cwd(), 'machine', 'ts', 'src', 'rompack', 'host_system_atlas.generated.ts');
export const HOST_SYSTEM_ATLAS_CPP_HEADER_PATH = join(process.cwd(), 'machine', 'cpp', 'src', 'rompack', 'host_system_atlas.generated.h');
export const HOST_SYSTEM_ATLAS_CPP_SOURCE_PATH = join(process.cwd(), 'machine', 'cpp', 'src', 'rompack', 'host_system_atlas.generated.cpp');
