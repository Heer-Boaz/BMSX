...
import {
	...
	type ImgMeta,
	type RomAsset,
} from '../../packages/bmsx-console/src/rompack/format';
import { SYSTEM_ROM_NAME } from '../../packages/bmsx-console/src/core/system';
import {
	commonResPath,
	createAtlasses,
	generateRomAssets,
...
export const HOST_SYSTEM_ATLAS_TS_PATH = join(process.cwd(), 'packages', 'bmsx-console', 'src', 'rompack', 'host_system_atlas.generated.ts');
export const HOST_SYSTEM_ATLAS_CPP_HEADER_PATH = join(process.cwd(), 'native', 'machine', 'rompack', 'host_system_atlas.generated.h');
export const HOST_SYSTEM_ATLAS_CPP_SOURCE_PATH = join(process.cwd(), 'native', 'machine', 'rompack', 'host_system_atlas.generated.cpp');
