...
export const HOST_SYSTEM_ATLAS_CPP_HEADER_PATH = join(process.cwd(), 'src', 'bmsx_cpp', 'rompack', 'host_system_atlas_generated.h');
export const HOST_SYSTEM_ATLAS_CPP_SOURCE_PATH = join(process.cwd(), 'src', 'bmsx_cpp', 'rompack', 'host_system_atlas_generated.cpp');
