...
| `STUDIO-BEHAVIOR-DEFINITION-01` | Ingeladen definitie en geselecteerde actorstate als afzonderlijke inspectiedoelen, met bestaande Lua als auteursbron. `behavior_definition_inspection_design.md` vergelijkt UE5, Godot/LimboAI en Qt Creator. **D2-leesbasis gebouwd:** de bestaande hover/memberreader gebruikt echte guestwaarden en compilerlocaties, geen interpreterfallback. Zie `lua_runtime_inspection.md` voor LLDB/LLVM/VS Code-referenties en TS/C++-symbolparity. | Echte ActionEffect-definitie/instance-readback, no-change init, rebindstop, gewijzigde installatie, compilefout en rewind op drie browserrenderers. D2-selectie/presentatie, catalogus en definitie-sourcecorrespondentie blijven open. BT-opnamekeuze pas na lowering-/heap-/tickbewijs. Geen nieuw resource-type, fake loader, per-actor graphkopie of closure-decompiler. De afzonderlijke reboot/rewind-glyphfout is hersteld bij de presentatiemaat-owner; zie `host_presentation_sizing.md` voor maatasserties en echte pixelparity. |
