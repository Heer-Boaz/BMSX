...
| `STUDIO-BEHAVIOR-UX-B03` | Same-document BT reparent-gesture gebouwd: bronfeiten, transfer/binding, review en Undo. Zie `behavior_tree_reparenting.md`. | Vóór/na/in, lege parent/enige member, shared uses en initialisatie-review bewezen met echte pointer/Source/Undo op drie renderers. Cycles/lexical bindings en compiled task/evaluation-order getest. De afzonderlijke reparent→Save→live-BT-Hot-Resume-proef blijft open; geen cross-fileoperatie of sluiting van B04. |
