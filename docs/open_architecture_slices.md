...
BT-, FSM- en ActionEffect-data. Een afzonderlijke ontwerpslice kiest eerst de
canonieke constrained tekst- of resourcerepresentatie; een traceprojectie wordt
nooit stilzwijgend het editable graphmodel. Inspectie is aanvankelijk
