...
| `STUDIO-BEHAVIOR-DEFINITION-01` | **Ontwerp, niet geïmplementeerd:** ingeladen definitie en geselecteerde actorstate als afzonderlijke inspectiedoelen, met bestaande Lua als auteursbron. `behavior_definition_inspection_design.md` vergelijkt UE5, Godot/LimboAI en Qt Creator en benoemt de D2/D3-ownerproeven. | Eerst één behouden ActionEffect-definitie via echte guestinspectie; bron/installatie/registratie en restore-lifetime onderscheiden. BT-opnamekeuze pas na bewijs door de echte lowering en meting van heap/code/tickkosten. Geen nieuw resource-type, fake loader, per-actor graphkopie of closure-decompiler. |
