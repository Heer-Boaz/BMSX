...
| `STUDIO-FSM-GRAPH-VIEW-01` | Ontwerp en meet vóór implementatie de professionele layout/routing voor cycli, self-loops, parallelle edges en geneste/concurrent scopes; consumeer daarna de bewezen FSM-projectie in de gedeelde canvas. | Zelfstandige fixtures en live 384×288-captures bewijzen leesbare scopes en afzonderlijk selecteerbare edges met hun eigen bronbewijs. Geen BT-tree-/aigen-DAG-normalisatie van FSM-semantiek. De precieze layoutkeuze staat nog open in `behavior_graph_design.md`. |
