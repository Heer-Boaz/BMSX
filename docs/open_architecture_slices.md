...
| `STUDIO-BEHAVIOR-UX-B06` | Presentatie/inspectie herzien: twaalf rollen, requirements eenmaal op volle regelbreedte, alias/partialstatus, callbackparameters en volledige bron via B01. Zie `actioneffect_properties_design.md`. | **Open:** echte property-edit met draft/cancel/Undo op B04. De drie rendererproeven bewijzen de nieuwe lees-/Source-route, niet de nog ontbrekende authoring. Geen extra cartlib-metadata. |
