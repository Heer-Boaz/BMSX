...
| 27 | Open | Lua VM heap representation | Small-object heapdruk terugbrengen bij de echte VM/table/closure owners in plaats van gameplay- of API-wrappers toe te voegen. | Steady-state heapmeting toont structureel minder kleine allocaties zonder extra guards, fallbacks of hot-path GC-churn. |
