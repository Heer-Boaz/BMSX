...
| `STUDIO-BEHAVIOR-UX-B07` | Uitgewerkt: één graph/viewport-zoomtransformatie voor render, input, scroll en reveal; focuscommands, Ctrl-wheel en 100%-reset. Zie `graph_zoom_design.md`. Minimap optioneel daarna. | Anker, glyphs, negatieve ruimte, hit/drop/reveal, Source/Back/Undo en echte Studio-workflows op software/WebGL2/WebGPU; native software/GLES2-transformtests. Geen shrink-to-fit of sourcewijziging. Overhead gemeten; B03/B04/B06-authoring niet hiermee afgesloten. |
