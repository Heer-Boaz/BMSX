...
| `STUDIO-BEHAVIOR-DEFINITION-01` | Ingeladen definitie en geselecteerde actorstate als afzonderlijke inspectiedoelen, met bestaande Lua als auteursbron. `behavior_definition_inspection_design.md` vergelijkt UE5, Godot/LimboAI en Qt Creator. **D2-leesbasis en gerichte selectie gebouwd:** hover/memberreader en de ActionEffect-/FSM-Live-kiezers/property inspector gebruiken echte guestwaarden; de bestaande registry-type-index levert grants, geen bronkandidaten. Zie `lua_runtime_inspection.md`, `actioneffect_runtime_inspection.md` en `state_machine_runtime_inspection.md` voor productievoorbeelden en TS/C++-grenzen. | Echte ActionEffect-definitie/instance-readback, no-change init, rebindstop, gewijzigde installatie, compilefout en rewind op drie browserrenderers. De echte UI bewijst selectie, niet-mutating callback-Source, source-divergence en beëindiging van geleende inspecties. Callback-Source volgt de instruction-busmapping, niet het eerste passende ROM. FSM-inspectie kiest eerst een echte machine en daarna haar retained state; eigen nodedata/definitie blijven correct midden in rebind en geïmporteerde callbacks krijgen hun echte Source. Catalogus inclusief ongebruikte definities, algemene actorselectie en definitie-allocation-/registratiecorrespondentie blijven open. BT-opnamekeuze pas na lowering-/heap-/tickbewijs. Geen nieuw resource-type, fake loader, per-actor graphkopie of closure-decompiler. De afzonderlijke reboot/rewind-glyphfout is hersteld bij de presentatiemaat-owner; zie `host_presentation_sizing.md` voor maatasserties en echte pixelparity. |
