...
BT-, FSM- en ActionEffect-definities. De bestaande Lua-bron blijft daarbij de
enige authored waarheid: source- en visual-view delen hetzelfde textmodel,
dezelfde undo/save-lifecycle en dezelfde Hot-Resume-route. Een afgeleide
projectie of trace wordt nooit stilzwijgend het editable graphmodel. Inspectie
is aanvankelijk stop-and-inspect; exacte per-node runtimecorrespondence valt
buiten de eerste lens en libretro blijft speler/core. Geen van deze keuzes maakt Studio tot machine-, cart-, cartlib- of
