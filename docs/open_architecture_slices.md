...
| `STUDIO-BEHAVIOR-UX-B04` | Resource-eigen bronherkomst, write-targets en snapshot-/dependencygeldigheid binnen de bestaande declaratieve cartlib-norm. De scope is op 2026-09-13 aangescherpt in `behavior_definition_inspection_design.md` (D1); onbeperkte factory-/wrapperreconstructie is geen gate voor alle UX. | Imports, gedeelde declaraties, callbackbron en unsaved dependencies behouden correcte Source/Back en Undo. Geen runtimepublicatie claimen op basis van modulepad/const-spelling of één kandidaat. Cross-file mutations vereisen gedeelde edit/history; geen tweede semantic engine of gekookt behaviorresource. |
