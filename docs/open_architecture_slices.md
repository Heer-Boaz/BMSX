...
| `STUDIO-BT-GRAPH-VIEW-01` | **Geïmplementeerd (2026-09-09).** Bouw na bron- en viewportcontract één gekozen BT als echte ordered grafiek, met subtree-collapse, attachments/details op verzoek en normale source-navigation. Layout volgt gemeten boomplaatsing en behoudt Lua-volgorde; een gedeelde initializer blijft meerdere occurrences. | Leesbaar en fysiek bedienbaar op 384×288 met IDE-tiny-font, keyboard/controller/pointer en alle drie backends. Fixtures meten projection/layout/hit/draw apart; echte carts zijn integratiesmoke. Geen onleesbare zoom-to-fit of permanente brede zijpanelen. Nog geen authoring, graph-naar-Lua-serializer of live execution overlay. Bewijs en aparte kostenmetingen: `behavior_graph_design.md` en `tests/conformance/behavior_graph/README.md`. Source-selection bezit geen verborgen outline; edge/choice-use-provenance, details en held input zijn zelfstandig getest. |
