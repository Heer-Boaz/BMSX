...
- `machine/ts/machine/devices/vdp/rpu_desc.ts` — descriptor byte-offset constants (new)
- `machine/cpp/machine/devices/vdp/rpu_desc.h` — C++ descriptor byte offsets (new)
- `machine/ts/machine/devices/vdp/rpu.ts` — VdpRpuUnit, VdpRpuCommandBuffer, new opcodes
- `machine/cpp/machine/devices/vdp/rpu.h` / `rpu.cpp` — C++ mirror
- `machine/ts/render/backend/webgl/vdp_rpu.ts` — read from vdpVram
- `machine/cpp/render/backend/gles2/vdp_rpu.cpp` — read from vdpVram
- `machine/cpp/render/backend/software/vdp_rpu.cpp` — read from vdpVram
