...
Input timelines can now carry `capture: true` markers. The libretro host and headless runner write `.png` screenshots to a `screenshots/` subfolder next to the timeline JSON file.
