...
import { getSymbolSearchBarBounds, symbolSearchEntryHeight, symbolSearchVisibleResultCount } from '../../../editor/ui/view/view';
...
import { ensureSymbolSearchSelectionVisible } from '../../../editor/contrib/symbols/shared';
