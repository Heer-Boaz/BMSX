-- engine/system.lua
-- Cart-bundled game engine library facade. This is not part of the BIOS ROM.

local world_module<const> = require('engine/world/index')
...
local subsystem<const> = require('engine/subsystem/index')
local spriteobject<const> = require('engine/sprite')
local textobject<const> = require('engine/text/object')
