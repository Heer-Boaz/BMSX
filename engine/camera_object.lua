...
local camera<const>     = require('engine/camera')
...
local projection<const> = require('engine/projection')
...
-- Delegates to engine/projection.lua — mirrors Camera.rebuild()'s switch block in TS.
