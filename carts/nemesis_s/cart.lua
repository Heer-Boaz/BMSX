...
local function init<init>()
	...
	starfield.register()
	player_start.register()
	caption.register()
	curtain.register()
	hangar_ship.register()
	title_scene.register()
	hangar_scene.register()
	intro_scene.register()
	story_scene.register()
	end_demo_scene.register()
	stage_actors.register()
