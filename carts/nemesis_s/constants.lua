...
player_option_pickup_velocity_x_q8 = -0x0100
...
mijter_foe_attack_speed_q8 = 0x0400
...
schoorsteen_ray_step_ms = 20
schoorsteen_ray_tile_size = 8
schoorsteen_ray_growth_tiles = 3
schoorsteen_ray_max_steps = 10
schoorsteen_ray_draw_z = 55

rook_generator_health = 15
rook_generator_initial_wait_ms = 1000
rook_generator_min_wait_ms = 1000
rook_generator_max_wait_ms = 2999
rook_generator_spawn_interval_ms = 200
rook_generator_spawn_count = 6
rook_generator_width = 24
rook_generator_draw_z = 50
rook_spawn_offset_x = 4
rook_spawn_offset_y = -12
rook_health = 1
rook_animation_frame_ms = 100
rook_leave_speed = 2
rook_leave_distance = 48
rook_attack_speed_q8 = 0x0200
rook_width = 16
rook_height = 16
rook_draw_z = 60
...
zak_foe_horizontal_speed = 1
zak_foe_initial_vertical_speed = -1
zak_foe_vertical_acceleration = 0.2
zak_foe_width = 16
zak_foe_draw_z = 60
enemy_bullet_speed_q8 = 0x0180
enemy_bullet_size = 4
...
moon_death_ray_growth_tiles = 3
moon_death_ray_max_steps = 30
moon_death_ray_step_ms = 20
...
moon_small_ray_speed = 16
moon_small_ray_draw_z = 70
mini_moon_health = 1
mini_moon_speed_q8 = 0x0200
...
assets_game_over_curtain = 'game_over_curtain'
