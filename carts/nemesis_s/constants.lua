...
moon_enter_interval_ticks = 5
moon_mini_spawn_interval_ticks = 10
moon_small_ray_move_interval_ticks = 5
moon_small_ray_flash_ticks = 13
moon_small_ray_volley_interval_ticks = 25
moon_slow_vertical_period_units = 3
moon_slow_vertical_units_per_tick = 2
moon_wait_for_attack_ticks = 25
moon_wait_for_explosion_ticks = 75
moon_wait_for_end_demo_ticks = 125
moon_fly_attack_weight = 7
moon_death_ray_attack_weight = 3
moon_rotation_up = 1
...
moon_death_ray_cycle_ticks = 40
moon_death_ray_move_accumulator_initial = 0xff
moon_death_ray_move_accumulator_step = 0x46
moon_death_ray_move_count_min = 7
moon_death_ray_move_count_max = 10
moon_death_ray_move_pause_ticks = 16
...
stars_yellow = {
	{ x = 4, y = 10 }, { x = 92, y = 10 }, { x = 184, y = 10 }, { x = 196, y = 10 },
	{ x = 60, y = 43 }, { x = 236, y = 43 }, { x = 76, y = 58 }, { x = 220, y = 74 },
	{ x = 36, y = 75 }, { x = 140, y = 91 }, { x = 4, y = 10 }, { x = 172, y = 107 },
	{ x = 4, y = 10 }, { x = 99, y = 122 }, { x = 131, y = 138 }, { x = 155, y = 138 },
	{ x = 179, y = 154 },
}

stars_blue = {
	{ x = 44, y = 3 }, { x = 20, y = 35 }, { x = 124, y = 35 }, { x = 204, y = 35 },
	{ x = 108, y = 51 }, { x = 134, y = 67 }, { x = 252, y = 67 }, { x = 52, y = 99 },
	{ x = 116, y = 99 }, { x = 212, y = 99 }, { x = 243, y = 115 }, { x = 67, y = 132 },
	{ x = 187, y = 132 }, { x = 99, y = 122 }, { x = 27, y = 127 }, { x = 227, y = 127 },
}
