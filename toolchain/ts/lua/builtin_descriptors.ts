...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'load', params: ['chunk', 'chunkname?', 'mode?', 'env?'], signature: 'load(chunk [, chunkname [, mode [, env]]])', description: 'Compiles the firmware assignment-function subset into BLua32 records and instructions in RAM.' },
