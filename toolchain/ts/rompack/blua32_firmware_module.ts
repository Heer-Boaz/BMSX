...
export const BLUA32_FIRMWARE_MODULE_SOURCE = [
	...
	`\tfunction_code_address_word_index = ${BLUA32_FUNCTION_CODE_ADDRESS_OFFSET >>> 2},`,
	`\tfunction_code_byte_count_word_index = ${BLUA32_FUNCTION_CODE_BYTE_COUNT_OFFSET >>> 2},`,
	`\tfunction_num_params_word_index = ${BLUA32_FUNCTION_NUM_PARAMS_OFFSET >>> 2},`,
	`\tfunction_max_stack_word_index = ${BLUA32_FUNCTION_MAX_STACK_OFFSET >>> 2},`,
	`\tfunction_flags_word_index = ${BLUA32_FUNCTION_FLAGS_OFFSET >>> 2},`,
	`\tfunction_upvalue_table_address_word_index = ${BLUA32_FUNCTION_UPVALUE_TABLE_ADDRESS_OFFSET >>> 2},`,
	`\tfunction_upvalue_count_word_index = ${BLUA32_FUNCTION_UPVALUE_COUNT_OFFSET >>> 2},`,
	`\tfunction_reserved_word_index = ${BLUA32_FUNCTION_RESERVED_OFFSET >>> 2},`,
	...
	`\top_le = ${OpCode.LE},`,
	`\top_jmp = ${OpCode.JMP},`,
	`\top_jmpif = ${OpCode.JMPIF},`,
	`\top_jmpifnot = ${OpCode.JMPIFNOT},`,
	`\top_call = ${OpCode.CALL},`,
