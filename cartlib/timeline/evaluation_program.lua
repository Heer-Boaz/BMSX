...
local seek_event_shape_shift<const> = play_event_shape_shift + event_lane_shape.bit_count
local scrub_event_shape_shift<const> = seek_event_shape_shift + event_lane_shape.bit_count
local shape_apply_function<const> = 1 << (scrub_event_shape_shift + event_lane_shape.bit_count)
local shape_frame_appliers<const> = shape_apply_function << 1
local shape_subsequences<const> = shape_frame_appliers << 1
local shape_evaluation_context<const> = shape_subsequences << 1
