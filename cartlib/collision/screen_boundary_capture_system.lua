...
function screen_boundary_capture_system.new(world)
	...
	self._boundary_component_view = world:_active_component_view(screen_boundary_type)
	self._prohibit_leaving_component_view = world:_active_component_view(prohibit_leaving_screen_type)
	return self
end
