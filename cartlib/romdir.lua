...
local active_plus_system_roms<const> = { false, system_rom }
local system_roms<const> = { system_rom }

local function reload_cartridge_directory<init>()
...
romdir.reload_cartridge_directory = reload_cartridge_directory
