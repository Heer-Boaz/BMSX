...
void resolveVdpTransformSnapshot(VdpTransformSnapshot& target,
	...
	const size_t viewBase = static_cast<size_t>((viewMatrixIndex & (VDP_XF_MATRIX_COUNT - 1u)) * VDP_XF_MATRIX_WORDS);
	const size_t projectionBase = static_cast<size_t>((projectionMatrixIndex & (VDP_XF_MATRIX_COUNT - 1u)) * VDP_XF_MATRIX_WORDS);
