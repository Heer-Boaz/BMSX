...
constexpr int IO_VDP_MODE_INDEX = IO_VDP_FIFO_CTRL_INDEX + 1;
...
constexpr int IO_SYS_REGION_INDEX = IO_SYS_FRAME_MS_INDEX + 1;
constexpr int IO_SYS_PRINT_CHAR_INDEX = IO_SYS_REGION_INDEX + 1;
...
constexpr int IO_GX_GTE_DATA0_INDEX = IO_SYS_CYCLES_PER_FRAME_INDEX + 1;
...
constexpr int IO_SLOT_COUNT = IO_GX_GTE_CYCLES_INDEX + 1;
...
constexpr uint32_t IO_SYS_REGION = IO_BASE + IO_SYS_REGION_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t IO_VDP_MODE = IO_BASE + IO_VDP_MODE_INDEX * IO_WORD_SIZE;
