...
constexpr i64 GX_GPU_PCRTC_FRAME_MILLISECONDS_Q16_NUMERATOR =
	1000 * GX_GPU_PCRTC_HZ_SCALE * 0x1'0000;
...
struct GxGpuPcrtcCircuit {
	...
	u32 fieldSourceDivisionMultiplierY = 1u << GX_GPU_PCRTC_SOURCE_DIVISION_SHIFT;
	u32 linearFieldSourceY = 0u;
	u32 linearFieldSourceRowStep = 1u;
...
struct GxGpuPcrtcTiming {
	...
	u32 frameDurationMillisecondsQ16 = static_cast<u32>(
