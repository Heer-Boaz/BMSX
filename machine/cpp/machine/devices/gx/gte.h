...
constexpr u32 GX_GTE_FN_DPCS = 0x10u;
constexpr u32 GX_GTE_FN_INTPL = 0x11u;
constexpr u32 GX_GTE_FN_MVMVA = 0x12u;
constexpr u32 GX_GTE_FN_NCDS = 0x13u;
constexpr u32 GX_GTE_FN_CDP = 0x14u;
constexpr u32 GX_GTE_FN_NCDT = 0x16u;
constexpr u32 GX_GTE_FN_NCCS = 0x1bu;
constexpr u32 GX_GTE_FN_CC = 0x1cu;
constexpr u32 GX_GTE_FN_NCS = 0x1eu;
constexpr u32 GX_GTE_FN_NCT = 0x20u;
constexpr u32 GX_GTE_FN_SQR = 0x28u;
constexpr u32 GX_GTE_FN_DCPL = 0x29u;
constexpr u32 GX_GTE_FN_DPCT = 0x2au;
constexpr u32 GX_GTE_FN_AVSZ3 = 0x2du;
constexpr u32 GX_GTE_FN_AVSZ4 = 0x2eu;
constexpr u32 GX_GTE_FN_RTPT = 0x30u;
constexpr u32 GX_GTE_FN_GPF = 0x3du;
constexpr u32 GX_GTE_FN_GPL = 0x3eu;
constexpr u32 GX_GTE_FN_NCCT = 0x3fu;

constexpr u32 GX_GTE_CYCLES_RTPS = 15u;
constexpr u32 GX_GTE_CYCLES_NCLIP = 8u;
constexpr u32 GX_GTE_CYCLES_OP = 6u;
constexpr u32 GX_GTE_CYCLES_DPCS = 8u;
constexpr u32 GX_GTE_CYCLES_INTPL = 8u;
constexpr u32 GX_GTE_CYCLES_MVMVA = 8u;
constexpr u32 GX_GTE_CYCLES_NCDS = 19u;
constexpr u32 GX_GTE_CYCLES_CDP = 13u;
constexpr u32 GX_GTE_CYCLES_NCDT = 44u;
constexpr u32 GX_GTE_CYCLES_NCCS = 17u;
constexpr u32 GX_GTE_CYCLES_CC = 11u;
constexpr u32 GX_GTE_CYCLES_NCS = 14u;
constexpr u32 GX_GTE_CYCLES_NCT = 30u;
constexpr u32 GX_GTE_CYCLES_SQR = 5u;
constexpr u32 GX_GTE_CYCLES_DCPL = 8u;
constexpr u32 GX_GTE_CYCLES_DPCT = 17u;
constexpr u32 GX_GTE_CYCLES_AVSZ3 = 5u;
constexpr u32 GX_GTE_CYCLES_AVSZ4 = 6u;
constexpr u32 GX_GTE_CYCLES_RTPT = 23u;
constexpr u32 GX_GTE_CYCLES_GPF = 5u;
constexpr u32 GX_GTE_CYCLES_GPL = 5u;
constexpr u32 GX_GTE_CYCLES_NCCT = 39u;
...
constexpr u32 GX_GTE_FLAG_COLOR_R_SAT = 0x00200000u;
constexpr u32 GX_GTE_FLAG_COLOR_G_SAT = 0x00100000u;
constexpr u32 GX_GTE_FLAG_COLOR_B_SAT = 0x00080000u;
...
private:
	...
	i32 macSigned44(u32 index, i64 value);
	void accumulateSigned44(i64 initial, i64 add0, i64 add1, i64 add2);
	i32 limitIr(u32 index, i32 value, u32 lm);
	void writeIrFromMac(u32 index, i32 value, u32 lm);
	void executeOp(u32 sf, u32 lm);
	void executeDpcs(u32 sf, u32 lm);
	void executeIntpl(u32 sf, u32 lm);
	void executeSqr(u32 sf, u32 lm);
	void matrixVectorMultiply(u32 matrix, u32 vectorIndex, u32 controlVector, u32 sf, u32 lm);
	void lightTransform(u32 vectorIndex, u32 sf, u32 lm);
	void colorMatrix(u32 sf, u32 lm);
	void colorApply(u32 sf, u32 lm);
	void depthCueColor(u32 sf, u32 lm);
	void executeNcsForVector(u32 vectorIndex, u32 sf, u32 lm);
	void executeNccsForVector(u32 vectorIndex, u32 sf, u32 lm);
	void executeNcdsForVector(u32 vectorIndex, u32 sf, u32 lm);
	void executeCc(u32 sf, u32 lm);
	void executeCdp(u32 sf, u32 lm);
	void executeDcpl(u32 sf, u32 lm);
	void executeDpct(u32 sf, u32 lm);
	void executeGpf(u32 sf, u32 lm);
	void executeGpl(u32 sf, u32 lm);
	void executeMvmva(u32 opcode, u32 sf, u32 lm);
	void depthCue(i64 inR, i64 inG, i64 inB, u32 sf, u32 lm);
	...
	i32 limitColor(i32 value, u32 flag);
	void pushRgbFromMac();
