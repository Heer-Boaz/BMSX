...
function placeAxisLabel(view: GameView, originX: number, originY: number, vx: number, vy: number, letter: string, col: color, scale: number, aspect: number, width: number, height: number, emitHostImage: AxisGizmoHostImageSink): void {
...
export function renderAxisGizmo_WebGL(backend: WebGLBackend, gv: GameView, emitHostImage: AxisGizmoHostImageSink): void {
	...
	placeAxisLabel(gv, offsetX, offsetY, view[0], view[1], 'X', AXIS_LABEL_X_COLOR, axisLabelScale(axisInvRot[8]), aspect, w, h, emitHostImage);
	placeAxisLabel(gv, offsetX, offsetY, view[4], view[5], 'Y', AXIS_LABEL_Y_COLOR, axisLabelScale(axisInvRot[9]), aspect, w, h, emitHostImage);
	placeAxisLabel(gv, offsetX, offsetY, view[8], view[9], 'Z', AXIS_LABEL_Z_COLOR, axisLabelScale(axisInvRot[10]), aspect, w, h, emitHostImage);

	placeAxisLabel(gv, offset2X, offset2Y, axisInvRot[0], axisInvRot[1], 'R', AXIS_LABEL_R_COLOR, axisLabelScale(axisInvRot[8]), aspect, w, h, emitHostImage);
	placeAxisLabel(gv, offset2X, offset2Y, axisInvRot[4], axisInvRot[5], 'U', AXIS_LABEL_U_COLOR, axisLabelScale(axisInvRot[9]), aspect, w, h, emitHostImage);
	placeAxisLabel(gv, offset2X, offset2Y, axisInvRot[8], axisInvRot[9], 'F', AXIS_LABEL_F_COLOR, axisLabelScale(axisInvRot[10]), aspect, w, h, emitHostImage);
