...
export const GEO_SCRATCH_SIZE = 0x00080000; // 512 KB
export const MIN_RAM_SIZE = IO_REGION_SIZE + GEO_SCRATCH_SIZE;
export const BASE_RAM_USED_SIZE = GEO_SCRATCH_SIZE;
