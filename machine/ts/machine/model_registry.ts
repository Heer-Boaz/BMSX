...
export const PSX_BIOS_RENDER_WIDTH = 320;
export const PSX_BIOS_RENDER_HEIGHT = 240;
...
export type MachineModelProfile = {
	...
	slotBytes: number;
	stagingBytes: number;
	biosRenderWidth: number;
	biosRenderHeight: number;
};
...
export const PSX_MODEL_PROFILE: MachineModelProfile = {
	...
	biosRenderWidth: PSX_BIOS_RENDER_WIDTH,
	biosRenderHeight: PSX_BIOS_RENDER_HEIGHT,
};
