...
export const APU_SAMPLE_RAM_BASE = 0x4000_0000;
...
export const APU_PARAMETER_FILTER_CONTROL_INDEX = 14;
export const APU_PARAMETER_FILTER_B0_B1_INDEX = 15;
export const APU_PARAMETER_FILTER_B2_A1_INDEX = 16;
export const APU_PARAMETER_FILTER_A2_INDEX = 17;
...
export const APU_FILTER_CONTROL_ENABLE = 1 << 0;
export const APU_FILTER_COEFFICIENT_FRACTION_BITS = 14;
export const APU_FILTER_COEFFICIENT_ONE = 1 << APU_FILTER_COEFFICIENT_FRACTION_BITS;
