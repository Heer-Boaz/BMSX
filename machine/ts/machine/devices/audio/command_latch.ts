...
function resetApuCommandLatch(memory: Memory): void {
	...
	memory.writeValue(IO_APU_FILTER_CONTROL, 0);
	memory.writeValue(IO_APU_FILTER_B0_B1, APU_FILTER_COEFFICIENT_ONE);
	memory.writeValue(IO_APU_FILTER_B2_A1, 0);
	memory.writeValue(IO_APU_FILTER_A2, 0);
