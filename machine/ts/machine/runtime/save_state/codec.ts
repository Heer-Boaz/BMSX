...
function encodeFrameSchedulerState(state: FrameSchedulerStateSnapshot): FrameSchedulerStateSnapshot {
	return {
		...
		logicalTickRunPending: state.logicalTickRunPending,
		logicalTickRunTargetSequence: state.logicalTickRunTargetSequence,
...
function decodeFrameSchedulerState(value: unknown, label: string): FrameSchedulerStateSnapshot {
	...
	return {
		...
		logicalTickRunPending: requireBooleanValue(requireObjectKey(object, 'logicalTickRunPending', label, 'frameScheduler.logicalTickRunPending'), 'frameScheduler.logicalTickRunPending'),
		logicalTickRunTargetSequence: requireI64(requireObjectKey(object, 'logicalTickRunTargetSequence', label, 'frameScheduler.logicalTickRunTargetSequence'), 'frameScheduler.logicalTickRunTargetSequence'),
...
function encodeGxGpuIngressContextState(state: GxGpuIngressContextState): GxGpuIngressContextState {
	return {
		...
		gp0PolylineOpcode: state.gp0PolylineOpcode >>> 0,
		gp0PolylineColorWord: state.gp0PolylineColorWord >>> 0,
		gp0PolylinePositionWord: state.gp0PolylinePositionWord >>> 0,
		gp0PolylineNextColorWord: state.gp0PolylineNextColorWord >>> 0,
...
function decodeGxGpuIngressContextState(value: unknown, label: string): GxGpuIngressContextState {
	...
	return {
		...
		gp0PolylinePayloadPhase: requireBoundedU32(requireObjectKey(object, 'gp0PolylinePayloadPhase', label, `${label}.gp0PolylinePayloadPhase`), `${label}.gp0PolylinePayloadPhase`, 0, 1),
		gp0PolylineOpcode: requireBoundedU32(requireObjectKey(object, 'gp0PolylineOpcode', label, `${label}.gp0PolylineOpcode`), `${label}.gp0PolylineOpcode`, 0, 0xff),
		gp0PolylineColorWord: requireBoundedU32(requireObjectKey(object, 'gp0PolylineColorWord', label, `${label}.gp0PolylineColorWord`), `${label}.gp0PolylineColorWord`, 0, 0xffffffff),
		gp0PolylinePositionWord: requireBoundedU32(requireObjectKey(object, 'gp0PolylinePositionWord', label, `${label}.gp0PolylinePositionWord`), `${label}.gp0PolylinePositionWord`, 0, 0xffffffff),
		gp0PolylineNextColorWord: requireBoundedU32(requireObjectKey(object, 'gp0PolylineNextColorWord', label, `${label}.gp0PolylineNextColorWord`), `${label}.gp0PolylineNextColorWord`, 0, 0xffffffff),
