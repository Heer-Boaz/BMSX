...
SNESMINI_C_FLAGS ?= -U_GNU_SOURCE -U_ISOC2X_SOURCE -U_TIME_BITS -D_TIME_BITS=32
SNESMINI_CXX_FLAGS ?= -U_GNU_SOURCE -U_ISOC2X_SOURCE -U_TIME_BITS -D_TIME_BITS=32 -D_GLIBCXX_USE_CXX11_ABI=0 -DBMSX_SNESMINI_LEGACY=1 -fno-sized-deallocation
