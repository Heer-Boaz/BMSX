...
import { joinWorkspacePaths, normalizeRelativeWorkspacePath } from './path';
...
function createWorkspaceLuaSourceRecord(registry: LuaSourceRegistry, path: string, record: WorkspaceRecord): LuaSourceRecord {
