...
import { Table, asStringId, valueIsString, type Closure, type NativeFunction, type NativeObject, type Value, isNativeFunction, isNativeObject } from '../../machine/ts/machine/cpu/cpu';
