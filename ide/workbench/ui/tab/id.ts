...
export type EditorTabId = CodeEditorTabId | ResourceViewerTabId | BehaviorLensTabId | ScenarioLabTabId | SceneEditorTabId | 'actor-lab' | 'game-view' | `edit-review:${number}`;
