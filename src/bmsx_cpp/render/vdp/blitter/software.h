...
private:
	...
	static void rasterizeFrameBufferBlit(VDP& vdp, std::vector<u8>& pixels, const VDP::BlitterSource& source, f32 dstX, f32 dstY, f32 scaleX, f32 scaleY, bool flipH, bool flipV, f32 parallaxWeight, const VDP::FrameBufferColor& color, Layer2D layer, f32 z, u32 seq);
