...
constexpr int IO_APU_SYNC_LOOP_INDEX = IO_APU_BASE_INDEX + 13;
...
constexpr uint32_t IO_APU_SYNC_LOOP = IO_BASE + IO_APU_SYNC_LOOP_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t APU_CMD_QUEUE_PLAY = 3;
