...
constexpr int IO_APU_SELECTED_SOURCE_ADDR_INDEX = IO_APU_BASE_INDEX + 26;
constexpr int IO_APU_ACTIVE_MASK_INDEX = IO_APU_BASE_INDEX + 27;
constexpr int IO_APU_SELECTED_SLOT_REG0_INDEX = IO_APU_BASE_INDEX + 28;
constexpr int IO_APU_SELECTED_SLOT_REG_COUNT = 20;
constexpr int IO_APU_SIZE = 28 + IO_APU_SELECTED_SLOT_REG_COUNT;
