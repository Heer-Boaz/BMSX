...
constexpr int IO_APU_VOICE_INDEX = IO_APU_BASE_INDEX + 11;
constexpr int IO_APU_TARGET_GAIN_Q12_INDEX = IO_APU_BASE_INDEX + 12;
constexpr int IO_APU_CMD_INDEX = IO_APU_BASE_INDEX + 13;
constexpr int IO_APU_STATUS_INDEX = IO_APU_BASE_INDEX + 14;
constexpr int IO_APU_EVENT_KIND_INDEX = IO_APU_BASE_INDEX + 15;
constexpr int IO_APU_EVENT_CHANNEL_INDEX = IO_APU_BASE_INDEX + 16;
constexpr int IO_APU_EVENT_HANDLE_INDEX = IO_APU_BASE_INDEX + 17;
constexpr int IO_APU_EVENT_VOICE_INDEX = IO_APU_BASE_INDEX + 18;
constexpr int IO_APU_EVENT_SEQ_INDEX = IO_APU_BASE_INDEX + 19;
constexpr int IO_APU_SIZE = 20;
...
constexpr uint32_t IO_APU_VOICE = IO_BASE + IO_APU_VOICE_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t APU_CMD_STOP_VOICE = 4;
constexpr uint32_t APU_CMD_RAMP_VOICE = 5;
...
constexpr uint32_t APU_EVENT_VOICE_STARTED = 2;
