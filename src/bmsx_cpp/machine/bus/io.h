...
constexpr int IO_APU_HANDLE_INDEX = IO_APU_BASE_INDEX;
constexpr int IO_APU_CHANNEL_INDEX = IO_APU_BASE_INDEX + 1;
constexpr int IO_APU_PRIORITY_INDEX = IO_APU_BASE_INDEX + 2;
constexpr int IO_APU_PITCH_CENTS_INDEX = IO_APU_BASE_INDEX + 3;
constexpr int IO_APU_VOLUME_MILLIDB_INDEX = IO_APU_BASE_INDEX + 4;
constexpr int IO_APU_OFFSET_MS_INDEX = IO_APU_BASE_INDEX + 5;
constexpr int IO_APU_RATE_PERMIL_INDEX = IO_APU_BASE_INDEX + 6;
constexpr int IO_APU_FILTER_KIND_INDEX = IO_APU_BASE_INDEX + 7;
constexpr int IO_APU_FILTER_FREQ_HZ_INDEX = IO_APU_BASE_INDEX + 8;
constexpr int IO_APU_FILTER_Q_MILLI_INDEX = IO_APU_BASE_INDEX + 9;
constexpr int IO_APU_FILTER_GAIN_MILLIDB_INDEX = IO_APU_BASE_INDEX + 10;
constexpr int IO_APU_FADE_MS_INDEX = IO_APU_BASE_INDEX + 11;
constexpr int IO_APU_CROSSFADE_MS_INDEX = IO_APU_BASE_INDEX + 12;
constexpr int IO_APU_SYNC_INDEX = IO_APU_BASE_INDEX + 13;
constexpr int IO_APU_START_AT_LOOP_INDEX = IO_APU_BASE_INDEX + 14;
constexpr int IO_APU_START_FRESH_INDEX = IO_APU_BASE_INDEX + 15;
constexpr int IO_APU_CMD_INDEX = IO_APU_BASE_INDEX + 16;
constexpr int IO_APU_STATUS_INDEX = IO_APU_BASE_INDEX + 17;
constexpr int IO_APU_EVENT_KIND_INDEX = IO_APU_BASE_INDEX + 18;
constexpr int IO_APU_EVENT_CHANNEL_INDEX = IO_APU_BASE_INDEX + 19;
constexpr int IO_APU_EVENT_HANDLE_INDEX = IO_APU_BASE_INDEX + 20;
constexpr int IO_APU_EVENT_VOICE_INDEX = IO_APU_BASE_INDEX + 21;
constexpr int IO_APU_EVENT_SEQ_INDEX = IO_APU_BASE_INDEX + 22;
constexpr int IO_APU_SIZE = 23;
...
constexpr uint32_t IO_APU_HANDLE = IO_BASE + IO_APU_HANDLE_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_CHANNEL = IO_BASE + IO_APU_CHANNEL_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_PRIORITY = IO_BASE + IO_APU_PRIORITY_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_PITCH_CENTS = IO_BASE + IO_APU_PITCH_CENTS_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_VOLUME_MILLIDB = IO_BASE + IO_APU_VOLUME_MILLIDB_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_OFFSET_MS = IO_BASE + IO_APU_OFFSET_MS_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_RATE_PERMIL = IO_BASE + IO_APU_RATE_PERMIL_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t IO_APU_FADE_MS = IO_BASE + IO_APU_FADE_MS_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_CROSSFADE_MS = IO_BASE + IO_APU_CROSSFADE_MS_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_SYNC = IO_BASE + IO_APU_SYNC_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_START_AT_LOOP = IO_BASE + IO_APU_START_AT_LOOP_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_START_FRESH = IO_BASE + IO_APU_START_FRESH_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t IO_APU_EVENT_CHANNEL = IO_BASE + IO_APU_EVENT_CHANNEL_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_EVENT_HANDLE = IO_BASE + IO_APU_EVENT_HANDLE_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_APU_EVENT_VOICE = IO_BASE + IO_APU_EVENT_VOICE_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t APU_CMD_STOP_CHANNEL = 2;
constexpr uint32_t APU_CHANNEL_SFX = 0;
constexpr uint32_t APU_CHANNEL_MUSIC = 1;
constexpr uint32_t APU_CHANNEL_UI = 2;
constexpr int32_t APU_PRIORITY_AUTO = -2147483647 - 1;
constexpr uint32_t APU_SYNC_IMMEDIATE = 0;
constexpr uint32_t APU_SYNC_LOOP = 1;
...
constexpr uint32_t APU_EVENT_VOICE_ENDED = 1;
