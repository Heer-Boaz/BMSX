...
constexpr int IO_APU_RATE_STEP_Q16_INDEX = IO_APU_BASE_INDEX + 3;
constexpr int IO_APU_GAIN_Q12_INDEX = IO_APU_BASE_INDEX + 4;
constexpr int IO_APU_START_SAMPLE_INDEX = IO_APU_BASE_INDEX + 5;
constexpr int IO_APU_FILTER_KIND_INDEX = IO_APU_BASE_INDEX + 6;
constexpr int IO_APU_FILTER_FREQ_HZ_INDEX = IO_APU_BASE_INDEX + 7;
constexpr int IO_APU_FILTER_Q_MILLI_INDEX = IO_APU_BASE_INDEX + 8;
constexpr int IO_APU_FILTER_GAIN_MILLIDB_INDEX = IO_APU_BASE_INDEX + 9;
constexpr int IO_APU_FADE_SAMPLES_INDEX = IO_APU_BASE_INDEX + 10;
constexpr int IO_APU_CROSSFADE_SAMPLES_INDEX = IO_APU_BASE_INDEX + 11;
constexpr int IO_APU_SYNC_LOOP_INDEX = IO_APU_BASE_INDEX + 12;
constexpr int IO_APU_START_AT_LOOP_INDEX = IO_APU_BASE_INDEX + 13;
constexpr int IO_APU_START_FRESH_INDEX = IO_APU_BASE_INDEX + 14;
constexpr int IO_APU_CMD_INDEX = IO_APU_BASE_INDEX + 15;
constexpr int IO_APU_STATUS_INDEX = IO_APU_BASE_INDEX + 16;
constexpr int IO_APU_EVENT_KIND_INDEX = IO_APU_BASE_INDEX + 17;
constexpr int IO_APU_EVENT_CHANNEL_INDEX = IO_APU_BASE_INDEX + 18;
constexpr int IO_APU_EVENT_HANDLE_INDEX = IO_APU_BASE_INDEX + 19;
constexpr int IO_APU_EVENT_VOICE_INDEX = IO_APU_BASE_INDEX + 20;
constexpr int IO_APU_EVENT_SEQ_INDEX = IO_APU_BASE_INDEX + 21;
constexpr int IO_APU_SIZE = 22;
...
constexpr uint32_t IO_APU_CROSSFADE_SAMPLES = IO_BASE + IO_APU_CROSSFADE_SAMPLES_INDEX * IO_WORD_SIZE;
