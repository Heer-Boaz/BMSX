...
void Runtime::setupBuiltins() {
	...
	setGlobal("sys_vdp_sbx_control", valueNumber(static_cast<double>(IO_VDP_SBX_CONTROL)));
	setGlobal("sys_vdp_sbx_faces", valueNumber(static_cast<double>(IO_VDP_SBX_FACE0)));
	setGlobal("sys_vdp_sbx_commit", valueNumber(static_cast<double>(IO_VDP_SBX_COMMIT)));
	setGlobal("sys_vdp_sbx_commit_write", valueNumber(static_cast<double>(VDP_SBX_COMMIT_WRITE)));
	setGlobal("sys_vdp_camera_view", valueNumber(static_cast<double>(IO_VDP_CAMERA_VIEW)));
	setGlobal("sys_vdp_camera_proj", valueNumber(static_cast<double>(IO_VDP_CAMERA_PROJ)));
	setGlobal("sys_vdp_camera_eye", valueNumber(static_cast<double>(IO_VDP_CAMERA_EYE)));
	setGlobal("sys_vdp_camera_commit", valueNumber(static_cast<double>(IO_VDP_CAMERA_COMMIT)));
	setGlobal("sys_vdp_camera_commit_write", valueNumber(static_cast<double>(VDP_CAMERA_COMMIT_WRITE)));
	...
	setGlobal("sys_vdp_status_fault", valueNumber(static_cast<double>(VDP_STATUS_FAULT)));
	setGlobal("sys_vdp_fault_none", valueNumber(static_cast<double>(VDP_FAULT_NONE)));
	setGlobal("sys_vdp_fault_rd_unsupported_mode", valueNumber(static_cast<double>(VDP_FAULT_RD_UNSUPPORTED_MODE)));
	setGlobal("sys_vdp_fault_rd_surface", valueNumber(static_cast<double>(VDP_FAULT_RD_SURFACE)));
	setGlobal("sys_vdp_fault_rd_oob", valueNumber(static_cast<double>(VDP_FAULT_RD_OOB)));
	setGlobal("sys_vdp_fault_vram_write_unmapped", valueNumber(static_cast<double>(VDP_FAULT_VRAM_WRITE_UNMAPPED)));
	...
	setGlobal("apu_cmd_stop_slot", valueNumber(static_cast<double>(APU_CMD_STOP_SLOT)));
	setGlobal("apu_cmd_ramp_slot", valueNumber(static_cast<double>(APU_CMD_RAMP_SLOT)));
	...
	setGlobal("apu_event_slot_ended", valueNumber(static_cast<double>(APU_EVENT_SLOT_ENDED)));
