...
constexpr uint32_t VRAM_ATLAS_SLOT_SIZE = 0x01000000u; // 16 MB
constexpr uint32_t VRAM_STAGING_SIZE = 0x00400000u; // 4 MB
constexpr uint32_t VRAM_SECONDARY_ATLAS_BASE = ASSET_DATA_END - VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t VRAM_PRIMARY_ATLAS_BASE = VRAM_SECONDARY_ATLAS_BASE - VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t VRAM_ENGINE_ATLAS_BASE = VRAM_PRIMARY_ATLAS_BASE - VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t VRAM_STAGING_BASE = VRAM_ENGINE_ATLAS_BASE - VRAM_STAGING_SIZE;
constexpr uint32_t VRAM_ENGINE_ATLAS_SIZE = VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t VRAM_PRIMARY_ATLAS_SIZE = VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t VRAM_SECONDARY_ATLAS_SIZE = VRAM_ATLAS_SLOT_SIZE;
constexpr uint32_t ASSET_DATA_ALLOC_END = VRAM_STAGING_BASE;
