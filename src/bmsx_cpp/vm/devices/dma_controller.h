...
public:
	...
	void enqueueImageCopy(const VmMemory::ImageWritePlan& plan, std::vector<uint8_t>&& pixels, std::function<void(bool error, bool clipped)> onComplete);
	void reset();
