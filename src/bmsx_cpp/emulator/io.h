...
constexpr int IO_VDP_OAM_FRONT_BASE_INDEX = IO_VDP_BASE_INDEX + 9;
constexpr int IO_VDP_OAM_BACK_BASE_INDEX = IO_VDP_BASE_INDEX + 10;
constexpr int IO_VDP_OAM_FRONT_COUNT_INDEX = IO_VDP_BASE_INDEX + 11;
constexpr int IO_VDP_OAM_BACK_COUNT_INDEX = IO_VDP_BASE_INDEX + 12;
constexpr int IO_VDP_OAM_CAPACITY_INDEX = IO_VDP_BASE_INDEX + 13;
constexpr int IO_VDP_OAM_ENTRY_WORDS_INDEX = IO_VDP_BASE_INDEX + 14;
constexpr int IO_VDP_OAM_READ_SOURCE_INDEX = IO_VDP_BASE_INDEX + 15;
constexpr int IO_VDP_OAM_COMMIT_SEQ_INDEX = IO_VDP_BASE_INDEX + 16;
constexpr int IO_VDP_OAM_CMD_INDEX = IO_VDP_BASE_INDEX + 17;
constexpr int IO_VDP_SIZE = 18;
...
constexpr uint32_t IO_VDP_OAM_FRONT_BASE = IO_BASE + IO_VDP_OAM_FRONT_BASE_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_BACK_BASE = IO_BASE + IO_VDP_OAM_BACK_BASE_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_FRONT_COUNT = IO_BASE + IO_VDP_OAM_FRONT_COUNT_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_BACK_COUNT = IO_BASE + IO_VDP_OAM_BACK_COUNT_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_CAPACITY = IO_BASE + IO_VDP_OAM_CAPACITY_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_ENTRY_WORDS = IO_BASE + IO_VDP_OAM_ENTRY_WORDS_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_READ_SOURCE = IO_BASE + IO_VDP_OAM_READ_SOURCE_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_COMMIT_SEQ = IO_BASE + IO_VDP_OAM_COMMIT_SEQ_INDEX * IO_WORD_SIZE;
constexpr uint32_t IO_VDP_OAM_CMD = IO_BASE + IO_VDP_OAM_CMD_INDEX * IO_WORD_SIZE;
...
constexpr uint32_t VDP_OAM_READ_SOURCE_FRONT = 0u;
constexpr uint32_t VDP_OAM_READ_SOURCE_BACK = 1u;
constexpr uint32_t OAM_CMD_SWAP = 1u;
constexpr uint32_t OAM_CMD_CLEAR_BACK = 2u;
