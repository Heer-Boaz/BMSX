...
uint32_t VDP_BGMAP_FRONT_BASE = VDP_OAM_BACK_BASE + VDP_OAM_BUFFER_SIZE;
uint32_t VDP_BGMAP_BACK_BASE = VDP_BGMAP_FRONT_BASE + VDP_BGMAP_BUFFER_SIZE;
uint32_t VDP_PAT_FRONT_BASE = VDP_BGMAP_BACK_BASE + VDP_BGMAP_BUFFER_SIZE;
uint32_t VDP_PAT_BACK_BASE = VDP_PAT_FRONT_BASE + VDP_PAT_BUFFER_SIZE;
uint32_t STRING_HANDLE_TABLE_BASE = VDP_PAT_BACK_BASE + VDP_PAT_BUFFER_SIZE;
