...
private:
	...
	void pushNumberToken(std::vector<LuaToken>& tokens, double value);
	void pushStringToken(std::vector<LuaToken>& tokens, const std::string& value);
