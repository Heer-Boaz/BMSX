...
combat_parallax_vy_base = 6
combat_parallax_vy_momentum = 4
combat_parallax_scale_base = 1
combat_parallax_scale_momentum = 0.04
combat_parallax_impact_amp = 0.08
combat_parallax_momentum_step = 0.45
combat_parallax_impact_duration_seconds = 1.2
combat_parallax_bias_base = 4
combat_parallax_bias_momentum = 2
combat_parallax_parallax_strength = 1
combat_parallax_scale_strength = 0.5
combat_parallax_flip_strength = 1
