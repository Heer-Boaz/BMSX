...
combat_hit_knockback_x = 12
combat_hit_knockback_y = -6
combat_hit_shake_frames = 3
combat_hit_shake_x = 4
combat_hit_shake_y = 3
...
combat_exchange_hitstop_frames = 2
combat_exchange_lunge_distance = 120
combat_exchange_lunge_lift = 18
combat_exchange_lunge_scale = 1.32
combat_exchange_lunge_punch = 0.18
combat_exchange_hit_recoil_distance = 8
combat_exchange_hit_recoil_lift = 18
combat_exchange_hit_shake_x = 12
combat_exchange_hit_shake_y = 9
combat_exchange_hit_overlay_alpha = 0.22
combat_exchange_miss_dodge_distance = 14
combat_exchange_miss_dodge_lift = 10
