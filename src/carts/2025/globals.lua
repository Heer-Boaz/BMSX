...
combat_exchange_hit_recoil_hold_frames = 4
combat_exchange_hit_recoil_recover_frames = 4
...
combat_exchange_miss_dodge_recover_frames = 4
...
combat_exchange_miss_dodge_scale_y = -0.03
