...
local enemy_def_id = string.format('%s.%s', constants.ids.enemy_def, 'zakfoe')
...
function zakfoe:spawn_child_enemy(kind, x, y, options)
	options = options or {}
...
function zakfoe:set_active_behaviour_tree(kind)
...
zakfoe.enemy_def_id = enemy_def_id
