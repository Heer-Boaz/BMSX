...
local enemy_def_id = string.format('%s.%s', constants.ids.enemy_def, 'boekfoe')
...
function boekfoe:spawn_child_enemy(kind, x, y, options)
	options = options or {}
...
function boekfoe:set_active_behaviour_tree(kind)
...
boekfoe.enemy_def_id = enemy_def_id
