...
// External helpers still hosted elsewhere during migration
declare function applySearchFieldText(text: string, resetSelection: boolean): void;
declare function clearReferenceHighlights(): void;
...
declare function resetBlink(): void;
declare function updateDesiredColumn(): void;
declare function revealCursor(): void;
declare function ensureCursorVisible(): void;
declare function enqueueBackgroundTask(cb: () => boolean | void): void;
declare function scheduleNextFrame(cb: () => void): void;
declare function openLuaCodeTab(descriptor: ConsoleResourceDescriptor): void;
declare function activateCodeTab(): void;
