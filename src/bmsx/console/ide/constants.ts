...
export const COLOR_NUMBER = 10; // Light yellow
...
export const COLOR_STATUS_WARNING = 9; // Light red
...
export const COLOR_PROBLEMS_PANEL_HOVER_TEXT = COLOR_STATUS_WARNING;
