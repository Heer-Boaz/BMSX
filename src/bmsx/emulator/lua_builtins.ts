...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'resolve_rom_asset_range', params: ['asset_id'], signature: 'resolve_rom_asset_range(asset_id)', description: 'Returns the ROM base and byte range for an asset id.' },
