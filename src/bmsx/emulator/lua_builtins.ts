...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_vdp_cmd_arg0', params: [], signature: 'sys_vdp_cmd_arg0', description: 'VDP command argument bank base address; write command arguments here before submitting.' },
	...
	{ name: 'sys_vdp_payload_write_ptr', params: [], signature: 'sys_vdp_payload_write_ptr', description: 'VDP payload write cursor maintained by the hardware allocator.' },
	{ name: 'sys_vdp_payload_alloc', params: [], signature: 'sys_vdp_payload_alloc', description: 'VDP payload allocator register; write a word count to reserve and arm the payload block that the next payload-consuming VDP command will use. Reading it returns the armed base offset.' },
	{ name: 'sys_vdp_payload_data', params: [], signature: 'sys_vdp_payload_data', description: 'VDP payload write port; each word write stores into the reserved payload block and auto-advances the internal cursor.' },
	{ name: 'sys_vdp_payload_buffer_base', params: [], signature: 'sys_vdp_payload_buffer_base', description: 'Base address of the VDP payload staging buffer.' },
	{ name: 'sys_vdp_payload_capacity', params: [], signature: 'sys_vdp_payload_capacity', description: 'VDP payload staging capacity in words.' },
...
const DEFAULT_LUA_BUILTIN_IDENTIFIER_EXTRAS = [
	...
	'sys_vdp_arg_stride',
	'sys_vdp_payload_write_ptr',
	'sys_vdp_payload_alloc',
	'sys_vdp_payload_data',
	'sys_vdp_payload_buffer_base',
	'sys_vdp_payload_capacity',
