...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'poke_words', params: ['addr', 'value...'], signature: 'poke_words(addr, ...)' },
	...
	{ name: 'sys_vdp_payload_write_ptr', params: [], signature: 'sys_vdp_payload_write_ptr', description: 'VDP payload write cursor; write the next payload length here before populating payload data.' },
