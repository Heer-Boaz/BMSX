...
import { DEFAULT_LUA_BUILTIN_FUNCTIONS, DEFAULT_LUA_BUILTIN_NAMES } from '../../../lua_builtin_descriptors';
...
import { isLuaCommentContext, wrapOverlayLine } from '../../core/text_utils';
import type { ApiCompletionMetadata, CodeTabContext, EditorContextToken, LuaCompletionItem, PointerSnapshot } from '../../core/types';
