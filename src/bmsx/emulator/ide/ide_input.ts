...
import { activeSearchMatchCount, applySearchSelection, closeSearch, ensureSearchSelectionVisible, focusEditorFromSearch, jumpToNextMatch, jumpToPreviousMatch, onSearchQueryChanged, openSearch, processInlineFieldPointer, searchPageSize, stepSearchSelection } from './editor_search';
...
import { moveCursorDown, moveCursorEnd, moveCursorHome, moveCursorLeft, moveCursorRight, moveCursorUp, pageDown, pageUp, revealCursor, setCursorPosition, updateDesiredColumn } from './caret';
import { isResourceViewActive, isCodeTabActive, isEditableCodeTab, isReadOnlyCodeTab, cycleTab, activateCodeTab, beginTabDrag, closeTab, endTabDrag, setActiveTab, getActiveCodeTabContext, updateTabDrag, closeActiveTab, save } from './editor_tabs';
...
import { resetActionPromptState, handleActionPromptSelection, performAction } from './action_prompt';
import { isPointInHoverTooltip, pointerHitsHoverTarget, adjustHoverTooltipScroll } from './hover_tooltip';
import { closeSymbolSearch, closeResourceSearch, closeLineJump, openSymbolSearch, openResourceSearch, openGlobalSymbolSearch, openReferenceSearchPopup, openRenamePrompt, openLineJump, moveResourceSearchSelection, ensureResourceSearchSelectionVisible, applyResourceSearchSelection, ensureSymbolSearchSelectionVisible, applySymbolSearchSelection, focusEditorFromLineJump, focusEditorFromResourceSearch, focusEditorFromSymbolSearch, moveSymbolSearchSelection, updateSymbolSearchMatches, applyLineJumpFieldText, updateResourceSearchMatches, applyLineJump } from './search_bars';
import { handleCreateResourceInput, openCreateResourcePrompt, closeCreateResourcePrompt } from './create_resource';
import { notifyReadOnlyEdit, getTabBarTotalHeight, getResourceSearchBarBounds, scrollResourceBrowser, getCodeAreaBounds, scrollRows, bottomMargin, hideResourcePanel, resetPointerClickTracking, getResourcePanelWidth, getCreateResourceBarBounds, resourceSearchEntryHeight, resourceSearchVisibleResultCount, getSymbolSearchBarBounds, symbolSearchVisibleResultCount, symbolSearchEntryHeight, getRenameBarBounds, getLineJumpBarBounds, getSearchBarBounds, searchVisibleResultCount, searchResultEntryHeight, resolvePointerRow, resolvePointerColumn, handlePointerAutoScroll, symbolSearchPageSize, resourceSearchWindowCapacity, mapScreenPointToViewport, toggleWordWrap } from './editor_view';
