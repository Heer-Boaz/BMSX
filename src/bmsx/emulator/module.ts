...
import { BMSX_CART_DRAW_SYSTEM_ID, BMSX_CART_UPDATE_SYSTEM_ID, BMSX_IDE_DRAW_SYSTEM_ID, BMSX_IDE_UPDATE_SYSTEM_ID, BMSX_TERMINAL_DRAW_SYSTEM_ID, BMSX_TERMINAL_UPDATE_SYSTEM_ID, BmsxCartDrawSystem, BmsxIDEInputSystem, BmsxCartUpdateSystem, BmsxIDEDrawSystem, BmsxIDEUpdateSystem, BmsxTerminalDrawSystem, BmsxTerminalUpdateSystem, BMSX_IDE_INPUT_SYSTEM_ID, BMSX_TERMINAL_INPUT_SYSTEM_ID, BmsxTerminalInputSystem } from './systems';
import { TickGroup } from '../ecs/ecsystem';

export function createEmulatorModule(): WorldModule {
	return {
		id: 'bmsx',
		ecs: {
			systems: [
