...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_inp_action', params: [], signature: 'sys_inp_action', description: 'Input Controller action-name register; write a string_ref before inp_ctrl_commit.' },
	...
	{ name: 'sys_inp_ctrl', params: [], signature: 'sys_inp_ctrl', description: 'Input Controller command register; write inp_ctrl_commit, inp_ctrl_latch, or inp_ctrl_reset.' },
	...
	{ name: 'sys_inp_consume', params: [], signature: 'sys_inp_consume', description: 'Input Controller consume register; write a string_ref action name to consume it.' },
	...
	{ name: 'inp_ctrl_latch', params: [], signature: 'inp_ctrl_latch', description: 'Input Controller command: acknowledge the current frame input snapshot.' },
