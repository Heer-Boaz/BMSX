...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_geo_status_busy', params: [], signature: 'sys_geo_status_busy', description: 'GEO status bit: busy.' },
	{ name: 'sys_geo_status_done', params: [], signature: 'sys_geo_status_done', description: 'GEO status bit: done.' },
	{ name: 'sys_geo_status_error', params: [], signature: 'sys_geo_status_error', description: 'GEO status bit: execution error.' },
	{ name: 'sys_geo_status_rejected', params: [], signature: 'sys_geo_status_rejected', description: 'GEO status bit: submit request rejected.' },
