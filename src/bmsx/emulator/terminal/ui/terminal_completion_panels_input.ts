import { consumeIdeKey, isAltDown, isCtrlDown, isKeyJustPressed, isMetaDown, isShiftDown } from '../../../ide/editor/input/keyboard/key_input';
import type { CompletionContext, LuaCompletionItem } from '../../../ide/common/types';
import type { CompletionController } from '../../../ide/editor/contrib/suggest/completion_controller';
