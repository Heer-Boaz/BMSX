...
// format.h: constexpr const char* ENGINE_ATLAS_TEXTURE_KEY = "_atlas_engine";
...
// Initial BIOS boot calls bootEngineStartupProgram() (engine.cpp) which calls:

// runtime.buildAssetMemory(m_engine_assets, true) (engine.cpp) — mode = Full
...
// When BIOS signals cart boot, Runtime::pollSystemBootRequest() (runtime.cpp) calls EngineCore::bootLoadedCart() (engine.cpp).

// bootLoadedCart calls:

// runtime.buildAssetMemory(assets(), false, Runtime::AssetBuildMode::Cart) (engine.cpp)
