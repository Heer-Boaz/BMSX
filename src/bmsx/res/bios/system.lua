...
system.vdp_clear_rgba = vdp_stream.clear_rgba
system.vdp_fill_rect_rgba = vdp_stream.fill_rect_rgba
system.vdp_draw_line_rgba = vdp_stream.draw_line_rgba
system.vdp_blit_img_rgba = vdp_image.write_blit_rgba
system.vdp_glyph_line_rgba = vdp_image.write_glyph_line_rgba
