...
local register_builtin_ecs<const> = function()
	...
	r:register_many({
		...
		{ id = 'physicssyncbefore', group = ecs.tickgroup.physics, default_priority = 0, create = function(p) return ecs_systems.physicssyncbeforestepsystem.new(p) end },
		{ id = 'physicsstep', group = ecs.tickgroup.physics, default_priority = 10, create = function(p) return ecs_systems.physicsworldstepsystem.new(p) end },
		{ id = 'physicspost', group = ecs.tickgroup.physics, default_priority = 20, create = function(p) return ecs_systems.physicspostsystem.new(p) end },
		...
		{ id = 'physicscollisionevents', group = ecs.tickgroup.physics, default_priority = 35, create = function(p) return ecs_systems.physicscollisioneventsystem.new(p) end },
		{ id = 'physicssyncafterworld', group = ecs.tickgroup.physics, default_priority = 37, create = function(p) return ecs_systems.physicssyncafterworldcollisionsystem.new(p) end },
		...
		{ id = 'transform', group = ecs.tickgroup.physics, default_priority = 50, create = function(p) return ecs_systems.transformsystem.new(p) end },
