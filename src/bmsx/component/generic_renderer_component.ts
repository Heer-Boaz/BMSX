...
import type { RenderSubmitQueue, ImgRenderSubmission, RectRenderSubmission, PolyRenderSubmission, MeshRenderSubmission, ParticleRenderSubmission } from 'bmsx/render/gameview';
...
export type RenderProducer = (ctx: { parent: WorldObject; rc: GenericRendererComponent }) => void;
 ...
 */
@insavegame
export class GenericRendererComponent extends Component {
    ...
    public setProducer(fn: RenderProducer | undefined): void {
	...
	public flush(queue: RenderSubmitQueue): void {
