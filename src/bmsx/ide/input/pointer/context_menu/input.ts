...
export function openEditorContextMenuFromPointer(runtime: Runtime, snapshot: PointerSnapshot, playerInput: ReturnType<typeof engineCore.input.getPlayerInput>): boolean {
