...
import { renderEditorContextMenu } from '../../workbench/render/render_context_menu';
import type { CodeAreaViewportBounds } from '../../workbench/contrib/context_menu/context_menu_widget';
