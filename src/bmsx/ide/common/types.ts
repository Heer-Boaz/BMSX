...
export type TopBarButtonId = import('../workbench/ui/top_bar_menu').TopBarButtonId;
export type MenuId = import('../workbench/ui/top_bar_menu').MenuId;
...
export type SymbolSearchState = {
	...
	referenceCatalog: import('../editor/contrib/references/reference_sources').ReferenceCatalogEntry[];
