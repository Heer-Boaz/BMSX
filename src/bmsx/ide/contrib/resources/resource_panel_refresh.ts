...
import type { ResourceBrowserItem, ResourceDescriptor } from '../../core/types';
...
import { ensureResourcePanelSelectionScroll } from './resource_panel_navigation';
import { resourcePanelLineCapacity } from './resource_panel_layout';
