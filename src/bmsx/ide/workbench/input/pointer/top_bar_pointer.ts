...
import { isTopBarCommandEnabled, MENU_COMMANDS, MENU_IDS, type MenuId, type TopBarButtonId } from '../../ui/top_bar_menu';
import { editorChromeState } from '../../ui/chrome_state';
import type { PointerSnapshot } from '../../../common/types';
import { executeTopBarCommand } from '../../../editor/input/commands/editor_commands';
