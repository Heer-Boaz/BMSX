...
import { getCodeAreaBounds, hideResourcePanel, getTabBarTotalHeight, selectResourceInPanel } from '../../editor/ui/editor_view';
...
import { measureText, bumpTextVersion, invalidateLuaCommentContextFromRow } from '../../common/text_utils';
...
import { tryShowLuaErrorOverlay } from '../../editor/contrib/runtime_error/runtime_error_navigation';
