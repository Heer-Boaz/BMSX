...
export const ENGINE_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'vdp_map_slot', params: ['slot', 'textpage_id?'], signature: 'vdp_map_slot(slot, textpage_id)', description: 'Maps an textpage resource id into a VRAM slot (slot 0=primary, 1=secondary; pass nil to clear).' },
	{ name: 'vdp_load_slot', params: ['slot', 'textpage_id'], signature: 'vdp_load_slot(slot, textpage_id)', description: 'Starts an async textpage load into a VRAM slot; BIOS maps the slot on completion; returns a job id.' },
	{ name: 'vdp_load_sys_textpage', params: [], signature: 'vdp_load_sys_textpage()', description: 'Starts an async load of the system textpage into the system VRAM slot; returns a job id.' },
...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_vdp_primary_textpage_id', params: [], signature: 'sys_vdp_primary_textpage_id', description: 'VDP primary textpage id register address; write textpage id or sys_vdp_textpage_none.' },
	{ name: 'sys_vdp_secondary_textpage_id', params: [], signature: 'sys_vdp_secondary_textpage_id', description: 'VDP secondary textpage id register address; write textpage id or sys_vdp_textpage_none.' },
	{ name: 'sys_vdp_textpage_none', params: [], signature: 'sys_vdp_textpage_none', description: 'Sentinel textpage id meaning no mapping.' },
