...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_apu_voice', params: [], signature: 'sys_apu_voice', description: 'APU voice id register for per-voice commands.' },
	...
	{ name: 'apu_event_voice_started', params: [], signature: 'apu_event_voice_started', description: 'APU event kind: voice started.' },
