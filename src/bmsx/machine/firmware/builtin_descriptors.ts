...
export const ENGINE_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'vdp_load_sys_textpage', params: [], signature: 'vdp_load_sys_textpage()', description: 'Starts an async load of the system atlas into the system VRAM slot; returns a job id.' },
...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'system_assets', params: [], signature: 'system_assets', description: 'BIOS/system asset registry with img/audio/data/model/audioevents tables.' },
	...
	{ name: 'sys_vram_system_textpage_base', params: [], signature: 'sys_vram_system_textpage_base', description: 'VRAM system textpage base address.' },
	{ name: 'sys_vram_primary_textpage_base', params: [], signature: 'sys_vram_primary_textpage_base', description: 'VRAM primary textpage slot base address.' },
	{ name: 'sys_vram_secondary_textpage_base', params: [], signature: 'sys_vram_secondary_textpage_base', description: 'VRAM secondary textpage slot base address.' },
	...
	{ name: 'sys_vram_system_textpage_size', params: [], signature: 'sys_vram_system_textpage_size', description: 'VRAM system textpage size in bytes.' },
	{ name: 'sys_vram_primary_textpage_size', params: [], signature: 'sys_vram_primary_textpage_size', description: 'VRAM primary textpage slot size in bytes.' },
	{ name: 'sys_vram_secondary_textpage_size', params: [], signature: 'sys_vram_secondary_textpage_size', description: 'VRAM secondary textpage slot size in bytes.' },
