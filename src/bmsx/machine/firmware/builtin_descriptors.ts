...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_apu_handle', params: [], signature: 'sys_apu_handle', description: 'APU audio asset handle register.' },
	{ name: 'sys_apu_channel', params: [], signature: 'sys_apu_channel', description: 'APU channel register: sfx, music, or ui.' },
	{ name: 'sys_apu_priority', params: [], signature: 'sys_apu_priority', description: 'APU voice priority register, or apu_priority_auto.' },
	...
	{ name: 'sys_apu_start_sample', params: [], signature: 'sys_apu_start_sample', description: 'APU start offset register in samples at apu_sample_rate_hz.' },
	...
	{ name: 'sys_apu_fade_samples', params: [], signature: 'sys_apu_fade_samples', description: 'APU music fade/stop duration register in samples at apu_sample_rate_hz.' },
	{ name: 'sys_apu_crossfade_samples', params: [], signature: 'sys_apu_crossfade_samples', description: 'APU music crossfade duration register in samples at apu_sample_rate_hz.' },
	{ name: 'sys_apu_sync_loop', params: [], signature: 'sys_apu_sync_loop', description: 'APU music sync-to-loop flag register.' },
	{ name: 'sys_apu_start_at_loop', params: [], signature: 'sys_apu_start_at_loop', description: 'APU music start-at-loop-start register.' },
	{ name: 'sys_apu_start_fresh', params: [], signature: 'sys_apu_start_fresh', description: 'APU music start-fresh register.' },
	...
	{ name: 'sys_apu_event_channel', params: [], signature: 'sys_apu_event_channel', description: 'APU event channel register.' },
	{ name: 'sys_apu_event_handle', params: [], signature: 'sys_apu_event_handle', description: 'APU event asset handle register.' },
	{ name: 'sys_apu_event_voice', params: [], signature: 'sys_apu_event_voice', description: 'APU event voice id register.' },
	...
	{ name: 'apu_channel_music', params: [], signature: 'apu_channel_music', description: 'APU channel constant for music.' },
	{ name: 'apu_channel_ui', params: [], signature: 'apu_channel_ui', description: 'APU channel constant for UI sounds.' },
	...
	{ name: 'apu_priority_auto', params: [], signature: 'apu_priority_auto', description: 'APU priority sentinel that lets the audio asset metadata choose priority.' },
	...
	{ name: 'apu_event_voice_ended', params: [], signature: 'apu_event_voice_ended', description: 'APU event kind: voice ended.' },
