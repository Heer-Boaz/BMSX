...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_rom_img', params: [], signature: 'sys_rom_img', description: 'Active ROM image metadata table.' },
	{ name: 'sys_rom_data', params: [], signature: 'sys_rom_data', description: 'Active ROM decoded data table.' },
	{ name: 'sys_rom_audio', params: [], signature: 'sys_rom_audio', description: 'Active ROM audio payload table.' },
	{ name: 'sys_rom_audioevents', params: [], signature: 'sys_rom_audioevents', description: 'Active ROM audio-event table.' },
	{ name: 'sys_system_rom_img', params: [], signature: 'sys_system_rom_img', description: 'System ROM image metadata table.' },
