...
export const DEFAULT_LUA_BUILTIN_FUNCTIONS: ReadonlyArray<LuaBuiltinDescriptor> = [
	...
	{ name: 'sys_host_fault_stage_startup_audio_refresh', params: [], signature: 'sys_host_fault_stage_startup_audio_refresh', description: 'Host fault stage constant for deferred startup audio refresh failures.' },
	...
	{ name: 'sys_apu_pitch_cents', params: [], signature: 'sys_apu_pitch_cents', description: 'APU pitch modulation register in cents.' },
	{ name: 'sys_apu_volume_millidb', params: [], signature: 'sys_apu_volume_millidb', description: 'APU volume modulation register in milli-decibels.' },
	{ name: 'sys_apu_offset_ms', params: [], signature: 'sys_apu_offset_ms', description: 'APU start offset register in milliseconds.' },
	{ name: 'sys_apu_rate_permil', params: [], signature: 'sys_apu_rate_permil', description: 'APU playback-rate register in permil; 1000 means normal speed.' },
	...
	{ name: 'sys_apu_fade_ms', params: [], signature: 'sys_apu_fade_ms', description: 'APU music fade/stop duration register in milliseconds.' },
	{ name: 'sys_apu_crossfade_ms', params: [], signature: 'sys_apu_crossfade_ms', description: 'APU music crossfade duration register in milliseconds.' },
	{ name: 'sys_apu_sync', params: [], signature: 'sys_apu_sync', description: 'APU music sync register: immediate or loop.' },
	...
	{ name: 'apu_sync_immediate', params: [], signature: 'apu_sync_immediate', description: 'APU music sync constant: start immediately.' },
	{ name: 'apu_sync_loop', params: [], signature: 'apu_sync_loop', description: 'APU music sync constant: start at loop boundary/end.' },
