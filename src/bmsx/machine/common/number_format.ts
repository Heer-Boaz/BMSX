// Port of C++ number_format.h to keep runtime text output identical across TS and C++.
// We added this because the C++ runtime cannot rely on std::to_chars here, so it
