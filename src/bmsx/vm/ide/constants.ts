...
const PALETTE = {
	...
	gruvboxGreenDark: 72,
	gruvboxYellow: 73,
	gruvboxYellowDark: 74,
	gruvboxBlue: 75,
	gruvboxBlueDark: 76,
	gruvboxPurple: 77,
	gruvboxPurpleDark: 78,
	gruvboxAqua: 79,
	gruvboxAquaDark: 80,
	gruvboxOrange: 81,
	gruvboxOrangeDark: 82,
	gruvboxLineHighlight: 83,
	gruvboxSelection: 84,
	gruvboxScrollbarThumb: 85,
};
...
const THEME_DEFINITIONS: Record<string, ThemeDefinition> = {
	...
	gruvbox: {
		surfaces: {
			frame: PALETTE.gruvboxBg0,
			topBar: PALETTE.gruvboxBg0,
			editor: PALETTE.gruvboxBg0,
			gutter: PALETTE.gruvboxBg0,
			resourcePanel: PALETTE.gruvboxBg0,
			resourcePanelHighlight: PALETTE.gruvboxLineHighlight,
			resourceViewer: PALETTE.gruvboxBg0,
			tabInactive: PALETTE.gruvboxBg0,
			tabActive: PALETTE.gruvboxBg1,
		},
		text: {
			topBar: PALETTE.gruvboxFg1,
			primary: PALETTE.gruvboxFg1,
			secondary: PALETTE.gruvboxFg2,
			keyword: PALETTE.gruvboxRed,
			string: PALETTE.gruvboxGreen,
			number: PALETTE.gruvboxPurple,
			comment: PALETTE.gruvboxGray,
			operator: PALETTE.gruvboxAqua,
			dim: PALETTE.gruvboxBg3,
			builtin: PALETTE.gruvboxOrange,
			functionName: PALETTE.gruvboxAqua,
			parameter: PALETTE.gruvboxBlue,
			globalVar: PALETTE.gruvboxPurple,
			label: PALETTE.gruvboxYellow,
			localTop: PALETTE.gruvboxBlue,
			localFunction: PALETTE.gruvboxAquaDark,
			functionHandle: PALETTE.gruvboxGreen,
			selection: PALETTE.gruvboxSelection,
			selectionBorder: PALETTE.gruvboxBg1,
			errorOverlayText: PALETTE.gruvboxFg1,
		},
		status: {
			background: PALETTE.gruvboxBg0,
			text: PALETTE.gruvboxFg1,
			warning: PALETTE.gruvboxYellowDark,
			success: PALETTE.gruvboxGreen,
			error: PALETTE.gruvboxRedDark,
			alert: PALETTE.gruvboxRed,
		},
		input: {
			text: PALETTE.gruvboxFg1,
			secondaryText: PALETTE.gruvboxFg3,
			placeholder: PALETTE.gruvboxFg3,
			outline: PALETTE.gruvboxBg1,
		},
		tab: {
			border: PALETTE.gruvboxBg1,
			activeText: PALETTE.gruvboxFg1,
			inactiveText: PALETTE.gruvboxFg4,
		},
		server_status: {
			connected: PALETTE.gruvboxGreen,
			disconnected: PALETTE.gruvboxRed,
		},
		searchBackground: PALETTE.gruvboxBg0,
		highlightOverlay: PALETTE.gruvboxLineHighlight,
		scrollbarThumb: PALETTE.gruvboxScrollbarThumb,
		caret: {
			editor: PALETTE.gruvboxFg1,
			inline: PALETTE.gruvboxBg0,
		},
		overlays: {
			search: {
				background: PALETTE.gruvboxBg0,
			...
			completion: {
				...
				border: PALETTE.gruvboxBg1,
				text: PALETTE.gruvboxFg1,
				detail: PALETTE.gruvboxFg3,
				previewText: PALETTE.gruvboxGray,
				highlight: PALETTE.gruvboxLineHighlight,
				highlightText: PALETTE.gruvboxAquaDark,
			},
			parameterHint: {
				background: PALETTE.gruvboxBg0,
				border: PALETTE.gruvboxBg1,
				text: PALETTE.gruvboxFg1,
				active: PALETTE.gruvboxYellowDark,
			},
			action: {
				dialogBackground: PALETTE.gruvboxBg0,
				dialogBorder: PALETTE.gruvboxBg1,
				dialogText: PALETTE.gruvboxFg1,
				buttonBackground: PALETTE.gruvboxBlueDark,
				buttonText: PALETTE.gruvboxFg1,
			},
			symbolSearch: {
				background: PALETTE.gruvboxBg0,
				text: PALETTE.gruvboxFg1,
