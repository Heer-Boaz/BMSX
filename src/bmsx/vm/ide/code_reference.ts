...
import type { VMCodeLayout } from './code_layout';
...
export type ReferenceSymbolEntry = VMLuaSymbolEntry & {
...
export function isLuaResourceDescriptor(descriptor: VMResourceDescriptor): boolean {
