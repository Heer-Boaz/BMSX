...
const frameRecovery = process.argv[2] === '--studio-frame-recovery';
const terminal = process.argv[2] === '--studio-terminal';
const editReview = process.argv[2] === '--studio-edit-review';
const resourceContext = process.argv[2] === '--studio-resource-context';
