...
import type { LuaCompletionItem, LuaCompletionKind } from '../../packages/bmsx-console/src/ide/common/models';
import {
	buildCanonicalCompletionItems,
	filterCompletionItems,
	resolveCompletionWordRange,
} from '../../packages/bmsx-console/src/ide/editor/contrib/suggest/completion_model';
