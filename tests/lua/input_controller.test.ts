...
import { InputController } from '../../packages/bmsx-console/src/machine/devices/input/controller';
import {
	INP_CTRL_ARM,
	INP_CTRL_COMMIT,
	IO_INP_ACTION,
...
import { CPU, asStringId, StringValue } from '../../packages/bmsx-console/src/machine/cpu/cpu';
import { Memory } from '../../packages/bmsx-console/src/machine/memory/memory';
import { Input, makeButtonState } from '../../packages/bmsx-console/src/input/manager';
import { PlayerInput } from '../../packages/bmsx-console/src/input/player';
import type { ButtonState, GamepadInputMapping, KeyboardInputMapping, PointerInputMapping } from '../../packages/bmsx-console/src/input/models';
import type { VibrationParams } from '../../packages/bmsx-console/src/platform';
import {
	INP_EVENT_CTRL_POP,
...
} from '../../packages/bmsx-console/src/machine/devices/input/contracts';
