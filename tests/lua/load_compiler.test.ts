...
import { compileLoadChunk } from '../../packages/bmsx-console/src/machine/program/load_compiler';
import { StringValue, Table } from '../../packages/bmsx-console/src/machine/cpu/cpu';
