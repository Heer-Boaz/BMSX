/* VS Code fuzzyScore at 7f59d5e01a7fafeba8e83cdfd9d8493f2beeeaca.
 * Copyright (c) Microsoft Corporation. MIT licensed; see ide/common/third_party_notices.md.
 * Unchanged recurrence/restoration and original 128-character bound. Debug-only
 * printing is removed; local constants and the upstream emoji classifier replace imports.
 */
const enum CharCode { Underline = 95, Dash = 45, Period = 46, Space = 32, Slash = 47, Backslash = 92,
	SingleQuote = 39, DoubleQuote = 34, Colon = 58, DollarSign = 36, LessThan = 60, GreaterThan = 62,
	OpenParen = 40, CloseParen = 41, OpenSquareBracket = 91, CloseSquareBracket = 93,
	OpenCurlyBrace = 123, CloseCurlyBrace = 125, Tab = 9 }
const _maxLen = 128;
