/* VS Code scoreFuzzy, pinned at 7f59d5e01a7fafeba8e83cdfd9d8493f2beeeaca.
 * Copyright (c) Microsoft Corporation. MIT licensed.
 * Extracted unchanged recurrence and position restoration; local constants
 * replace imports, and commented debug logging is omitted. Test oracle only.
 */
const enum CharCode { Slash = 47, Backslash = 92, Underline = 95, Dash = 45, Period = 46,
	Space = 32, SingleQuote = 39, DoubleQuote = 34, Colon = 58 }
function isUpper(code: number): boolean { return 65 <= code && code <= 90; }
