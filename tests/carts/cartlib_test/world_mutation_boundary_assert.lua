...
return {
	kind = 'unit',
	setup = function()
		world:configure({ framebuffer_count = 1, gameplay_interval_vblanks = 1, frame_interval_vblanks = 1, spaces = { 'main' }, systems = {} })
	end,
	tests = {
		publication_includes_lifecycle_completion = function(t)
			world:clear()
