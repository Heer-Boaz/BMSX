...
return {
	...
	tests = {
		enemy_feedback = function(t)
			...
			t:wait_until('enemy_feedback observation 1', function() return not (#test.small_explosions.objects > 0 or #test.large_explosions.objects > 0) end, 120)
