...
return {
	kind = 'integration',
	tests = {
		repeated_placement_has_independent_identity = function(t)
			t:wait_until('game fixture', function() return registry:get(director.director_instance_id) ~= nil end, 120)
