...
void testRuntimeSaveStateInterruptFieldsGolden() {
	...
	activeRpu.commands.passColorSurfaceDescAddr = {0x1000U};
	activeRpu.commands.passDepthSurfaceDescAddr = {0x1010U};
	...
	activeRpu.commands.drawIndexVramAddr = {0U};
	...
	activeRpu.commands.streamVramAddr = {0x2000U};
	activeRpu.commands.streamByteLength = {36U};
	activeRpu.commands.streamStepRate = {0U};
	activeRpu.commands.constantBindingSlot = {0U};
	activeRpu.commands.constantVramAddr = {0x3000U};
	activeRpu.commands.constantByteLength = {64U};
	activeRpu.commands.textureSlot = {0U};
	activeRpu.commands.textureSurfaceDescAddr = {0x1000U};
	state.machineState.machine.vdp.rpu.vdpVram = {0xaaU, 0xbbU, 0xccU};
	...
	require(decoded.machineState.machine.vdp.activeFrame.rpu.commands.passColorSurfaceDescAddr[0U] == 0x1000U, "save-state should preserve active VDP RPU color surface descriptor address");
	require(decoded.machineState.machine.vdp.activeFrame.rpu.commands.constantVramAddr[0U] == 0x3000U, "save-state should preserve active VDP RPU constant VDP-local address");
	require(decoded.machineState.machine.vdp.rpu.vdpVram[1U] == 0xbbU, "save-state should preserve VDP-local RPU VRAM bytes");
